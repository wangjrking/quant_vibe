...
REPORT_DIR = DATA_DIR / "reports" / "model_agent_research_5d_gate_refine_fullwindow_20260626"
...
FEATURES = ["rank_corr", "top20_overlap", "top10_overlap", "alt_std", "mean_abs_rank_gap", "base_std"]
...
def main() -> int:
    ...
    summary = {
        ...
        "scope": "research_only_5d_fullwindow_gate_refine",
