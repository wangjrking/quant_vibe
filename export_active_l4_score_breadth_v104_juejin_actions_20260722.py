...
def main() -> None:
    parser = argparse.ArgumentParser(description="导出 V104 冻结候选掘金动作")
    ...
    for case_id in args.case_id:
        daily, actions = v103.simulate(arrays, score, order, definitions[case_id], protocol, args.end_date, record_actions=True)
