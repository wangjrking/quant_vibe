...
OUT = ROOT / "quant" / "data_file" / "reports" / "strategy_agent_current_formal_l4_top1_gap4_sell_frequency_20260720"
LOGS = OUT / "logs"
...
CASES = [
    {"name": f"min{min_hold}_max{max_hold}", "min_hold": min_hold, "max_hold": max_hold}
    for min_hold, max_hold in (
        (8, 11), (8, 13), (9, 12), (9, 13),
        (10, 12), (10, 13), (10, 14),
        (11, 12), (11, 13), (11, 14),
        (12, 13), (12, 14), (12, 15),
...
def run_case(case: dict) -> dict:
    ...
    command = [
        ...
        "--target-position-pct", "1.0", "--score-db", str(MODULE.SCORE_DB),
