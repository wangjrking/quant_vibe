...
base.REPORT_DIR = (
    ...
    / "reports"
    / "strategy_agent_goal_high_annual_20260623"
    / "current_formal_exit10d_rankstate"
)
base.FUSION_DB = base.REPORT_DIR / "fusion_exit10d_rankstate.db"
base.SCORE_DB = base.REPORT_DIR / "scores_exit10d_rankstate.db"
...
base.VARIANTS = [
    ...
    _cfg(
        "top34_fast_only",
        {
            3: {"score_exit_entry_ratio": 0.95, "min_holding_days_before_score_exit": 1, "holding_days": 4},
            4: {"score_exit_entry_ratio": 0.96, "min_holding_days_before_score_exit": 1, "holding_days": 3},
        },
    ),
    _cfg(
        "top1_loose_34_fast",
        {
            1: {"score_exit_entry_ratio": 0.92, "holding_days": 6},
            3: {"score_exit_entry_ratio": 0.95, "min_holding_days_before_score_exit": 1, "holding_days": 4},
            4: {"score_exit_entry_ratio": 0.96, "min_holding_days_before_score_exit": 1, "holding_days": 3},
        },
    ),
    _cfg(
        ...
        {
            1: {"score_exit_entry_ratio": 0.92, "holding_days": 6},
            2: {"score_exit_entry_ratio": 0.93, "holding_days": 6},
            3: {"score_exit_entry_ratio": 0.95, "min_holding_days_before_score_exit": 1, "holding_days": 4},
            4: {"score_exit_entry_ratio": 0.96, "min_holding_days_before_score_exit": 1, "holding_days": 3},
        },
    ),
    ...
    _cfg(
        "top34_tight_only",
        {
            3: {"score_exit_entry_ratio": 0.95, "min_holding_days_before_score_exit": 1},
            4: {"score_exit_entry_ratio": 0.96, "min_holding_days_before_score_exit": 1},
        },
    ),
    _cfg(
        "rank_step_92349496",
        {
            1: {"score_exit_entry_ratio": 0.92, "holding_days": 6},
            2: {"score_exit_entry_ratio": 0.94, "holding_days": 5},
            3: {"score_exit_entry_ratio": 0.94, "holding_days": 4, "min_holding_days_before_score_exit": 1},
            4: {"score_exit_entry_ratio": 0.96, "holding_days": 3, "min_holding_days_before_score_exit": 1},
        },
    ),
    _cfg(
        "rank_step_93349495",
        {
            1: {"score_exit_entry_ratio": 0.93, "holding_days": 6},
            2: {"score_exit_entry_ratio": 0.94, "holding_days": 5},
            3: {"score_exit_entry_ratio": 0.94, "holding_days": 4, "min_holding_days_before_score_exit": 1},
            4: {"score_exit_entry_ratio": 0.95, "holding_days": 3, "min_holding_days_before_score_exit": 1},
        },
    ),
    _cfg(
        "top1_keep_others_base",
        {
            1: {"score_exit_entry_ratio": 0.91, "holding_days": 7},
        },
    ),
]
