...
OUT = ROOT / "quant/data_file/reports/strategy_agent_active_l4_max_positions_v195_20260723"
...
def stable_id(definition: dict) -> str:
    ...
    return "v195_" + hashlib.sha256(raw.encode("utf-8")).hexdigest()[:16]
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Active L4 最大并发持仓数研究")
