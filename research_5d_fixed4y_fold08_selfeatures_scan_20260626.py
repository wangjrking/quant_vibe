...
REPORT_DIR = DATA_DIR / "reports" / "model_agent_research_5d_fixed4y_fold08_selfeatures_scan_20260626"
...
CANDIDATES = [
    Candidate("self_ref", 5, 126, 0.005, 8.0, 6000, 0.003, 4, 4.0, 0.0),
    Candidate("self_top5_reg8", 5, 126, 0.005, 10.0, 6000, 0.003, 3, 8.0, 0.2),
    Candidate("self_top3_reg12", 3, 84, 0.003, 12.0, 5000, 0.004, 3, 12.0, 0.3),
]
...
def run_candidate(candidate: Candidate) -> dict:
    ...
    command = [
        ...
        "--output-table",
        f"stock_predict_data_model_agent_{candidate.name}_5d_fold08_20260626",
...
def main() -> int:
    ...
    packet = {
        ...
        "scope": "research_only_5d_fixed4y_fold08_selfeatures_scan",
        "label": LABEL,
