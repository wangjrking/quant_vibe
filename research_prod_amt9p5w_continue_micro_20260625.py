...
REPORT_DIR = DATA / "reports" / "strategy_agent_prod_amt9p5w_continue_micro_20260625"

CASES = [
    {
        "case_name": "amt9p5_pos8975_s7555_dd08_115_c097",
    ...
    {
        "case_name": "amt9p5_pos8975_s7555_dd08_115_c09725",
        "signal_file": DATA / "reports" / "strategy_agent_prod_filter_amount_interpolate_20260625" / "signals" / "prod_filter_amt9p5w_mv20w.csv",
        "target_pct": 0.8975,
        "dd_soft": 0.08,
        "dd_hard": 0.115,
        "dd_soft_scale": 0.75,
        "dd_hard_scale": 0.55,
        "continue_ratio": 0.9725,
    },
    {
        "case_name": "amt9p5_pos8975_s7555_dd08_115_c0975",
        "signal_file": DATA / "reports" / "strategy_agent_prod_filter_amount_interpolate_20260625" / "signals" / "prod_filter_amt9p5w_mv20w.csv",
        "target_pct": 0.8975,
        "dd_soft": 0.08,
        "dd_hard": 0.115,
    ...
    {
        "case_name": "amt9p5_pos8975_s7555_dd08_115_c09775",
        "signal_file": DATA / "reports" / "strategy_agent_prod_filter_amount_interpolate_20260625" / "signals" / "prod_filter_amt9p5w_mv20w.csv",
        "target_pct": 0.8975,
        "dd_soft": 0.08,
        "dd_hard": 0.115,
        "dd_soft_scale": 0.75,
        "dd_hard_scale": 0.55,
        "continue_ratio": 0.9775,
    },
    {
        "case_name": "amt9p5_pos8975_s7555_dd08_115_c098",
        "signal_file": DATA / "reports" / "strategy_agent_prod_filter_amount_interpolate_20260625" / "signals" / "prod_filter_amt9p5w_mv20w.csv",
        "target_pct": 0.8975,
        "dd_soft": 0.08,
        "dd_hard": 0.115,
