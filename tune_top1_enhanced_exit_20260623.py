...
OUT_DIR = REPORT_ROOT / "top1_enhanced_exit_20260623"
...
CANDIDATES = [
    {"name": "top1_h7_g138_e091_m2", "holding_days": 7, "gamma": 1.38, "exit_ratio": 0.91, "min_hold": 2},
    {"name": "top1_h5_g138_e094_m1", "holding_days": 5, "gamma": 1.38, "exit_ratio": 0.94, "min_hold": 1},
    {"name": "top1_h5_g138_e096_m1", "holding_days": 5, "gamma": 1.38, "exit_ratio": 0.96, "min_hold": 1},
    {"name": "top1_h5_g160_e094_m1", "holding_days": 5, "gamma": 1.60, "exit_ratio": 0.94, "min_hold": 1},
    {"name": "top1_h5_g160_e096_m1", "holding_days": 5, "gamma": 1.60, "exit_ratio": 0.96, "min_hold": 1},
    {"name": "top1_h5_g200_e096_m1", "holding_days": 5, "gamma": 2.00, "exit_ratio": 0.96, "min_hold": 1},
    {"name": "top1_h5_g200_e098_m1", "holding_days": 5, "gamma": 2.00, "exit_ratio": 0.98, "min_hold": 1},
    {"name": "top1_h3_g160_e096_m1", "holding_days": 3, "gamma": 1.60, "exit_ratio": 0.96, "min_hold": 1},
    {"name": "top1_h3_g200_e098_m1", "holding_days": 3, "gamma": 2.00, "exit_ratio": 0.98, "min_hold": 1},
    {"name": "top1_h7_g160_e094_m2", "holding_days": 7, "gamma": 1.60, "exit_ratio": 0.94, "min_hold": 2},
]
...
def _write_signal(base: pd.DataFrame, market: dict[str, dict[str, dict]], next_date: dict[str, str], cfg: dict) -> Path:
    ...
    selected = frame[frame["rn"] <= 1].copy()
...
def _write_score_table(base: pd.DataFrame, cfg: dict) -> tuple[Path, str]:
    score_db = OUT_DIR / "scores_top1_enhanced_exit.db"
...
def main() -> int:
    ...
    for cfg in CANDIDATES:
        ...
        for start_name, start in STARTS:
            ...
            _write_rows(OUT_DIR / "top1_cases.csv", rows)
    summary = _summarize(rows)
    _write_rows(OUT_DIR / "top1_summary.csv", summary)
    (OUT_DIR / "top1_summary.json").write_text(json.dumps(summary, ensure_ascii=False, indent=2), encoding="utf-8")
    return 0
