...
import research_v260_fixed10_sell_threshold_final_recheck_20260822 as final_threshold
...
OUTPUT_ROOT = (
    REPO
    / "quant/data_file/reports/strategy_agent_v260_fixed10_daily_exit_budget_20260822"
)
...
def main() -> None:
    ...
    if access["logical_max_date"] != round1.DEVELOPMENT_END:
        raise PermissionError("2026 data entered daily-exit-budget development")
    ...
    if not all(deterministic.values()):
        raise RuntimeError("daily-exit-budget deterministic replay failed")
