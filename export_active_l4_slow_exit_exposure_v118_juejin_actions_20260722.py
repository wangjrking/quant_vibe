...
import research_active_l4_slow_exit_exposure_v118_20260722 as v118
...
def main() -> None:
    parser = argparse.ArgumentParser(description="导出 V118 冻结候选的掘金动作")
    ...
    for case_id in args.case_id:
        ...
        current = v118.case_protocol(protocol, definition)
