...
$env:XGB_SAMPLE_WEIGHT_TOP_PCT = "0.01"
$env:XGB_SAMPLE_WEIGHT_TOP_MULTIPLIER = "6.0"
$env:XGB_DEVICE = "cuda"
$env:XGB_N_JOBS = "0"
$env:XGB_N_ESTIMATORS = "3500"
...
$out = "../data_file/reports/model_agent_research_3d_fixed2y_fold08_20260623"
...
& $python rolling_train_module.py `
  ...
  --fold-feature-top-n 64 `
  --fold-feature-min-abs-ic 0.003 `
  --fold-feature-max-missing-ratio 0.35 `
  --fold-feature-folds 6 `
  --fold-feature-output-dir "$out/feature_scores" `
  --output-table stock_predict_data_model_agent_research_3d_fixed2y_fold08_20260623 `
