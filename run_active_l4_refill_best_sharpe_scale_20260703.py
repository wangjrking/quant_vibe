...
OUT_DIR = REPORT_DIR / "variants_refill_best_sharpe_scale"
RUN_DIR = REPORT_DIR / "juejin_runs_refill_best_sharpe_scale"
SUMMARY_CSV = REPORT_DIR / "juejin_refill_best_sharpe_scale_summary.csv"
RAW_CSV = REPORT_DIR / "juejin_refill_best_sharpe_scale_raw.csv"


CASES = [
    ("scale050_cap70", 0.50, 0.70),
    ("scale060_cap70", 0.60, 0.70),
    ("scale070_cap70", 0.70, 0.70),
    ("scale075_cap70", 0.75, 0.70),
    ("scale080_cap70", 0.80, 0.70),
    ("scale085_cap70", 0.85, 0.70),
    ("scale090_cap70", 0.90, 0.70),
]
...
def main() -> int:
    ...
    summary = raw.sort_values(["sharp_ratio", "pnl_ratio_annual", "max_drawdown"], ascending=[False, False, True])
