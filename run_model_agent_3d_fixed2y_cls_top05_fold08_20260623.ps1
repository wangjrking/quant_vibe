...
$env:XGB_SAMPLE_WEIGHT_TOP_PCT = "0.05"
$env:XGB_SAMPLE_WEIGHT_TOP_MULTIPLIER = "10.0"
$env:XGB_DEVICE = "cuda"
$env:XGB_N_JOBS = "0"
$env:XGB_CLASS_N_ESTIMATORS = "3000"
$env:XGB_CLASS_LEARNING_RATE = "0.006"
$env:XGB_CLASS_MAX_DEPTH = "2"
$env:XGB_CLASS_REG_LAMBDA = "12"
$env:XGB_CLASS_REG_ALPHA = "0.2"
$env:XGB_CLASS_EARLY_STOPPING_ROUNDS = "300"

$python = "D:\work\quant\quant_mcp\.venv\Scripts\python.exe"
$root = "D:\work\quant\quant_mcp"
$main = Join-Path $root "quant\main"
$out = "../data_file/reports/model_agent_research_3d_fixed2y_cls_top05_fold08_20260623"
...
& $python rolling_train_module.py `
  ...
  --first-test 20240604 `
  --final-test 20260622 `
  --label executable_3d_open_top05 `
  --model-type class `
  --train-years 2 `
  --test-months 3 `
  --step-months 3 `
  ...
  --output-table stock_predict_data_model_agent_research_3d_fixed2y_cls_top05_fold08_20260623 `
