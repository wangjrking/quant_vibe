...
REPORT_DIR = BASE_DIR / "dynamic_h2_m3_sl06_dd0712_pos89_c975_scale_neighborhood_20260625"
SOURCE_SIGNAL = (
    BASE_DIR
...
BASE_CASE = {
    "case_name": "base_pos89_tp070_scale7050",
    "target_pct": 0.89,
    "exit_ratio": 0.970,
...
CASES = [
    BASE_CASE,
    {**BASE_CASE, "case_name": "pos89_scale7555", "dd_soft_scale": 0.75, "dd_hard_scale": 0.55},
    {**BASE_CASE, "case_name": "pos89_scale7858", "dd_soft_scale": 0.78, "dd_hard_scale": 0.58},
    {**BASE_CASE, "case_name": "pos89_scale8060", "dd_soft_scale": 0.80, "dd_hard_scale": 0.60},
    {**BASE_CASE, "case_name": "pos88_scale8060", "target_pct": 0.88, "dd_soft_scale": 0.80, "dd_hard_scale": 0.60},
    {**BASE_CASE, "case_name": "pos875_scale8060", "target_pct": 0.875, "dd_soft_scale": 0.80, "dd_hard_scale": 0.60},
    {**BASE_CASE, "case_name": "pos87_scale8060", "target_pct": 0.87, "dd_soft_scale": 0.80, "dd_hard_scale": 0.60},
    {**BASE_CASE, "case_name": "pos88_scale7858", "target_pct": 0.88, "dd_soft_scale": 0.78, "dd_hard_scale": 0.58},
    {**BASE_CASE, "case_name": "pos90_scale7555", "target_pct": 0.90, "dd_soft_scale": 0.75, "dd_hard_scale": 0.55},
    {**BASE_CASE, "case_name": "pos90_scale7858", "target_pct": 0.90, "dd_soft_scale": 0.78, "dd_hard_scale": 0.58},
    {**BASE_CASE, "case_name": "pos88_tp075_scale8060", "target_pct": 0.88, "take_profit": 0.075, "dd_soft_scale": 0.80, "dd_hard_scale": 0.60},
    {**BASE_CASE, "case_name": "pos89_tp075_scale7555", "take_profit": 0.075, "dd_soft_scale": 0.75, "dd_hard_scale": 0.55},
    {**BASE_CASE, "case_name": "pos88_dd0813_scale8060", "target_pct": 0.88, "dd_soft": 0.08, "dd_hard": 0.13, "dd_soft_scale": 0.80, "dd_hard_scale": 0.60},
    {**BASE_CASE, "case_name": "pos88_dd0611_scale8060", "target_pct": 0.88, "dd_soft": 0.06, "dd_hard": 0.11, "dd_soft_scale": 0.80, "dd_hard_scale": 0.60},
]
...
def _write_report(summary: list[dict], audit: dict) -> None:
    ...
    lines = [
        ...
        "## 当前结论",
        "",
        "本轮固定 formal L4 输入、Top1 股票池、ST/BJ/退市/涨停硬过滤和非行业非月份口径，只微调目标仓位、止盈、账户回撤触发和缩放强度。收益指标只用于排序，生产准入仍以硬过滤、低路径依赖、时间切片、贡献压力和掘金复现为准。",
        "",
    ...
    for row in ranked:
        params = (
            ...
            f"dd={_f(row['dd_soft']):.0%}/{_f(row['dd_hard']):.0%}, "
    ...
    (REPORT_DIR / "scale_neighborhood_report.md").write_text("\n".join(lines) + "\n", encoding="utf-8")
