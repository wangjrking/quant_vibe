...
STRATEGY_ID = "candidate_dynamic_h2m3_sl06dd0612_pos84_tp060_v20260624"
...
VALIDATION_DIR = BASE_REPORT_DIR / "dynamic_h2_m3_sl06_dd0612_pos84_tp060_validation_20260624"
...
SIGNAL_FILE = POSITION_DIR / "signals" / "tp060_pos84.csv"
...
def _trading_rules() -> dict:
    return {
        ...
        "strategy_name": "动态持有 Top1 三周期融合 pos84 6%止盈增强",
...
def _manifest_payload(validation: dict, signal_rows: list[dict]) -> dict:
    ...
    return {
        "schema_version": 1,
        "strategy_id": STRATEGY_ID,
        "name": "动态持有 Top1 三周期融合 pos84 6%止盈增强",
        "code_name": "dynamic_h2_m3_c098_w78_5d12_3d10_pos84_e097_mh1_sl06_dd0612_tp060",
        "status": "production_candidate_pending_audit_not_published",
        "created_at": "2026-06-24",
        "created_by": "strategy-agent",
        "definition": "基于 formal L4 10D/5D/3D 资产，按 0.78*10D rank + 0.12*5D rank + 0.10*3D rank 选 Top1，目标仓位 84%，动态持有 2-3 日，日内 6% 止损，账户回撤缩放，并新增 6% 止盈。",
        "input_contract": {
            "source_mode": "formal_l4_3d5d10d_only",
            "approval_required": "approved_for_l5",
            "legacy_odb_forbidden_by_default": True,
    ...
    return {
        ...
        "strong_gate_precheck": {
            ...
            "takeprofit_neighborhood": {
                ...
                "best_case": "tp060_pos84",
                "evidence": "research/position_report.md",
            },
...
def main() -> int:
    ...
    _copy(SIGNAL_FILE, ARCHIVE_DIR / "signals" / "historical_sl06_dd0612_pos84_tp060.csv")
    ...
    for script in [
        ...
        "validate_dynamic_h2_m3_sl06_dd0612_pos84_tp060_20260624.py",
        "archive_dynamic_h2_m3_sl06_dd0612_pos84_tp060_candidate_20260624.py",
    ]:
