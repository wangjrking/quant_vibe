...
SIGNAL_FILE = REPORT_DIR / "variants_lowgap_best_lightstop_cross" / "j08_ls0p08.csv"
OUT_DIR = REPORT_DIR / "j08_ls0p08_concentration"
...
def main() -> int:
    ...
    df["recent_bucket"] = "full"
    df.loc[df["recent_rank"] > max_rank - 120, "recent_bucket"] = "recent120"
    df.loc[df["recent_rank"] > max_rank - 60, "recent_bucket"] = "recent60"
    df.loc[df["recent_rank"] > max_rank - 20, "recent_bucket"] = "recent20"
