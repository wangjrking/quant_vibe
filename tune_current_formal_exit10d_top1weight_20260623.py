...
base.REPORT_DIR = (
    ...
    / "reports"
    / "strategy_agent_goal_high_annual_20260623"
    / "current_formal_exit10d_top1weight"
)
base.FUSION_DB = base.REPORT_DIR / "fusion_exit10d_top1weight.db"
base.SCORE_DB = base.REPORT_DIR / "scores_exit10d_top1weight.db"


def _cfg(name: str, targets: Dict[int, float], *, top1_exit_ratio: float = 0.91, top1_holding_days: int = 7) -> dict:
    return {
        "name": name,
        "w10": 0.80,
        "w5": 0.20,
...
base.VARIANTS = [
    _cfg("eq3305_base", {1: 0.3305, 2: 0.3305, 3: 0.3305, 4: 0.3305}),
    _cfg("top1_35_others324", {1: 0.3500, 2: 0.3240, 3: 0.3240, 4: 0.3240}),
    _cfg("top1_355_others322", {1: 0.3550, 2: 0.3220, 3: 0.3220, 4: 0.3220}),
    _cfg("top1_36_others321", {1: 0.3600, 2: 0.3210, 3: 0.3210, 4: 0.3210}),
    _cfg("top1_365_others319", {1: 0.3650, 2: 0.3190, 3: 0.3190, 4: 0.3190}),
    _cfg("top1_37_others317", {1: 0.3700, 2: 0.3170, 3: 0.3170, 4: 0.3170}),
    _cfg("top1_36_34_31_31", {1: 0.3600, 2: 0.3400, 3: 0.3100, 4: 0.3100}),
    _cfg("top1_37_33_31_31", {1: 0.3700, 2: 0.3300, 3: 0.3100, 4: 0.3100}),
    _cfg("top1_35_33_32_32", {1: 0.3500, 2: 0.3300, 3: 0.3200, 4: 0.3200}),
    _cfg("top1_36_r092", {1: 0.3600, 2: 0.3210, 3: 0.3210, 4: 0.3210}, top1_exit_ratio=0.92, top1_holding_days=7),
]
...
def _build_signals(cfg: dict) -> list[dict]:
    ...
    for row in rows:
        ...
        signal = {
            ...
            "target_pct": f"{targets.get(rank, 0.0):.5f}",
            "holding_days": 5,
            "max_holding_days": 7,
        }
        if rank == 1:
