...
REPORT_DIR = DATA_DIR / "reports" / "model_agent_four_year_candidate_stability_review_v12_20260628"
...
def main() -> int:
    ...
    summary_df.to_csv(REPORT_DIR / "candidate_stability_summary_v12.csv", index=False, encoding="utf-8-sig")

    summary = {
        "generated_at": now_iso(),
        "scope": "four_year_current_best_candidate_stability_review_v12",
    ...
    (REPORT_DIR / "candidate_stability_summary_v12.json").write_text(
    ...
    lines = [
        ...
        "- 本版统一采用当前真实 bestset：1D `splice_condblend`、3D `clear_replacement_gate`、5D `lightweight_blend_v1`、10D `active_recent_gate_hybrid_v2`。",
    ...
    (REPORT_DIR / "candidate_stability_review_v12.md").write_text("\n".join(lines) + "\n", encoding="utf-8")
