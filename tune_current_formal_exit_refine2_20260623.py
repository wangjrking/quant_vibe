...
base.REPORT_DIR = (
    ...
    / "reports"
    / "strategy_agent_goal_high_annual_20260623"
    / "current_formal_exit_refine2"
)
base.FUSION_DB = base.REPORT_DIR / "fusion_exit_refine2.db"
base.SCORE_DB = base.REPORT_DIR / "scores_exit_refine2.db"


def _cfg(name: str, *, scale: float, exit_ratio: str, min_exit_hold: int = 2) -> dict:
    return {
        "name": name,
        "w10": 0.80,
        "w5": 0.20,
...
base.VARIANTS = [
    _cfg("s104_exit093_mh2", scale=1.04, exit_ratio="0.93"),
    _cfg("s106_exit092_mh2", scale=1.06, exit_ratio="0.92"),
    _cfg("s106_exit093_mh2", scale=1.06, exit_ratio="0.93"),
    _cfg("s106_exit094_mh2", scale=1.06, exit_ratio="0.94"),
    _cfg("s108_exit092_mh2", scale=1.08, exit_ratio="0.92"),
    _cfg("s108_exit093_mh2", scale=1.08, exit_ratio="0.93"),
    _cfg("s110_exit093_mh2", scale=1.10, exit_ratio="0.93"),
    _cfg("s112_exit093_mh2", scale=1.12, exit_ratio="0.93"),
]
