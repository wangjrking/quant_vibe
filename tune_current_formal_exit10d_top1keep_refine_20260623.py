...
base.REPORT_DIR = (
    ...
    / "reports"
    / "strategy_agent_goal_high_annual_20260623"
    / "current_formal_exit10d_top1keep_refine"
)
base.FUSION_DB = base.REPORT_DIR / "fusion_exit10d_top1keep_refine.db"
base.SCORE_DB = base.REPORT_DIR / "scores_exit10d_top1keep_refine.db"
...
def _cfg(
    ...
    *,
    ...
    top1_min_hold: int | None = None,
    top1_continue_ratio: float | None = None,
    top1_max_holding_days: int | None = None,
) -> dict:
    return {
        "name": name,
        "w10": 0.80,
        ...
        "top1_rule": {
            ...
            **({"min_holding_days_before_score_exit": top1_min_hold} if top1_min_hold is not None else {}),
            **({"score_continue_entry_ratio": top1_continue_ratio} if top1_continue_ratio is not None else {}),
            **({"max_holding_days": top1_max_holding_days} if top1_max_holding_days is not None else {}),
        },
        "env": {
...
base.VARIANTS = [
    _cfg("top1_r090_h7", top1_exit_ratio=0.90, top1_holding_days=7),
    _cfg("top1_r091_h7", top1_exit_ratio=0.91, top1_holding_days=7),
    _cfg("top1_r092_h7", top1_exit_ratio=0.92, top1_holding_days=7),
    _cfg("top1_r091_h8", top1_exit_ratio=0.91, top1_holding_days=8),
    _cfg("top1_r091_h9", top1_exit_ratio=0.91, top1_holding_days=9),
    _cfg("top1_r091_h7_mh3", top1_exit_ratio=0.91, top1_holding_days=7, top1_min_hold=3),
    _cfg("top1_r091_h7_cont099_x9", top1_exit_ratio=0.91, top1_holding_days=7, top1_continue_ratio=0.99, top1_max_holding_days=9),
    _cfg("top1_r091_h7_cont098_x10", top1_exit_ratio=0.91, top1_holding_days=7, top1_continue_ratio=0.98, top1_max_holding_days=10),
    _cfg("top1_r090_h8_cont099_x10", top1_exit_ratio=0.90, top1_holding_days=8, top1_continue_ratio=0.99, top1_max_holding_days=10),
    _cfg("top1_r092_h6", top1_exit_ratio=0.92, top1_holding_days=6),
]
