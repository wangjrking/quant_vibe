...
SIGNALS = {
    ...
    "h8_top_ge0p4": SOURCE_DIR / "h8_top_ge0p4_targetbase.csv",
    "h8_top_ge0p45": SOURCE_DIR / "h8_top_ge0p45_targetbase.csv",
}
...
for signal_name, source in SIGNALS.items():
    for max_positions in (7, 8):
        GRID.append(
            {
                "name": f"{signal_name}_mp{max_positions}_target098div",
