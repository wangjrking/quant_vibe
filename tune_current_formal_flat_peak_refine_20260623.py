...
base.REPORT_DIR = (
    ...
    / "reports"
    / "strategy_agent_goal_high_annual_20260623"
    / "current_formal_flat_peak_refine"
)
base.FUSION_DB = base.REPORT_DIR / "fusion_flat_peak_refine.db"
base.SCORE_DB = base.REPORT_DIR / "scores_flat_peak_refine.db"
...
base.VARIANTS = [
    _cfg("flat025_s131", targets={1: 0.25, 2: 0.25, 3: 0.25, 4: 0.25}, scale=1.31),
    _cfg("flat025_s132", targets={1: 0.25, 2: 0.25, 3: 0.25, 4: 0.25}, scale=1.32),
    _cfg("flat025_s133", targets={1: 0.25, 2: 0.25, 3: 0.25, 4: 0.25}, scale=1.33),
    _cfg("flat025_s134", targets={1: 0.25, 2: 0.25, 3: 0.25, 4: 0.25}, scale=1.34),
    _cfg("flat025_s135", targets={1: 0.25, 2: 0.25, 3: 0.25, 4: 0.25}, scale=1.35),
    _cfg("flat025_s136", targets={1: 0.25, 2: 0.25, 3: 0.25, 4: 0.25}, scale=1.36),
    _cfg("flat025_s137", targets={1: 0.25, 2: 0.25, 3: 0.25, 4: 0.25}, scale=1.37),
    _cfg("flat025_s138", targets={1: 0.25, 2: 0.25, 3: 0.25, 4: 0.25}, scale=1.38),
    _cfg("flat025_s133_exit093", targets={1: 0.25, 2: 0.25, 3: 0.25, 4: 0.25}, scale=1.33, exit_ratio="0.93"),
    _cfg("flat025_s133_exit095", targets={1: 0.25, 2: 0.25, 3: 0.25, 4: 0.25}, scale=1.33, exit_ratio="0.95"),
    _cfg("flat025_s133_norank", targets={1: 0.25, 2: 0.25, 3: 0.25, 4: 0.25}, scale=1.33, exit_rank=None),
]
...
def _build_signals(cfg: dict) -> list[dict]:
    ...
    for row in rows:
        ...
        target = raw_target * float(cfg["scale"])
        signals.append(
            {
