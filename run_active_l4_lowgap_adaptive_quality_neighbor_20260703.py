...
OUT_DIR = REPORT_DIR / "variants_lowgap_adaptive_quality_neighbor"
RUN_DIR = REPORT_DIR / "juejin_runs_lowgap_adaptive_quality_neighbor"
MANIFEST_CSV = REPORT_DIR / "variants_lowgap_adaptive_quality_neighbor_manifest.csv"
RAW_CSV = REPORT_DIR / "juejin_lowgap_adaptive_quality_neighbor_raw.csv"
SUMMARY_CSV = REPORT_DIR / "juejin_lowgap_adaptive_quality_neighbor_summary.csv"


# name, pos_0_2_add, pos_gt2_add, neg_le_m2_add, neg_m2_0_add, atr24_add, atr_ge4_add
CASES = [
    ("n01_s08_p12_n03_z03_a18_g00", 0.08, -0.12, -0.03, 0.03, -0.18, 0.00),
    ("n02_s10_p12_n03_z03_a18_g00", 0.10, -0.12, -0.03, 0.03, -0.18, 0.00),
    ("n03_s12_p12_n03_z03_a18_g00", 0.12, -0.12, -0.03, 0.03, -0.18, 0.00),
    ("n04_s08_p16_n03_z03_a18_g00", 0.08, -0.16, -0.03, 0.03, -0.18, 0.00),
    ("n05_s10_p16_n03_z03_a18_g00", 0.10, -0.16, -0.03, 0.03, -0.18, 0.00),
    ("n06_s08_p20_n03_z03_a18_g00", 0.08, -0.20, -0.03, 0.03, -0.18, 0.00),
    ("n07_s08_p12_n06_z04_a18_g00", 0.08, -0.12, -0.06, 0.04, -0.18, 0.00),
    ("n08_s10_p16_n06_z04_a18_g00", 0.10, -0.16, -0.06, 0.04, -0.18, 0.00),
    ("n09_s08_p12_n03_z03_a22_g00", 0.08, -0.12, -0.03, 0.03, -0.22, 0.00),
    ("n10_s10_p16_n03_z03_a22_g00", 0.10, -0.16, -0.03, 0.03, -0.22, 0.00),
    ("n11_s08_p12_n03_z03_a25_g00", 0.08, -0.12, -0.03, 0.03, -0.25, 0.00),
    ("n12_s10_p16_n03_z03_a25_g00", 0.10, -0.16, -0.03, 0.03, -0.25, 0.00),
    ("n13_s08_p12_n03_z03_a18_g04", 0.08, -0.12, -0.03, 0.03, -0.18, 0.04),
    ("n14_s10_p16_n03_z03_a18_g04", 0.10, -0.16, -0.03, 0.03, -0.18, 0.04),
    ("n15_s08_p12_n03_z03_a22_g04", 0.08, -0.12, -0.03, 0.03, -0.22, 0.04),
    ("n16_s10_p16_n03_z03_a22_g04", 0.10, -0.16, -0.03, 0.03, -0.22, 0.04),
]
...
def target_for(row: pd.Series, case: tuple) -> float:
    _name, pos_0_2_add, pos_gt2_add, neg_le_m2_add, neg_m2_0_add, atr24_add, atr_ge4_add = case
