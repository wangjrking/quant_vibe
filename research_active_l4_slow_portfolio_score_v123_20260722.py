...
OUT = ROOT / "quant/data_file/reports/strategy_agent_active_l4_slow_portfolio_score_v123_20260722"
...
def stable_id(definition: dict) -> str:
    ...
    return "v123_" + hashlib.sha256(raw.encode("utf-8")).hexdigest()[:16]
...
def main() -> None:
    parser = argparse.ArgumentParser(description="正式L4单批组合的10D分数平滑研究")
