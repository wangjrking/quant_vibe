...
import research_active_l4_breadth_score_smooth_v112_20260722 as v112
...
def main() -> None:
    parser = argparse.ArgumentParser(description="导出 V112 冻结候选的掘金动作")
    ...
    for case_id in args.case_id:
        ...
        score, order = v112.score_pair(arrays, definition)
        current = v112.case_protocol(protocol, definition)
