...
SPECIAL_FILES = [
    ...
    "quant/main/tools/check_source_layout.py",
    ...
    "quant/main/legacy/dated-scripts/README.md",
    "quant/main/docs/governance/source-layout-policy.md",
    "quant/main/config/source_layout_policy_v1.json",
