...
OUT = ROOT / "quant/data_file/reports/strategy_agent_active_l4_sell_confirmation_v208_20260723"
...
def stable_id(definition: dict) -> str:
    ...
    return "v208_" + hashlib.sha256(raw.encode("utf-8")).hexdigest()[:16]
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Active L4 卖出确认天数研究")
