...
SIGNAL_DIR = OUT_DIR / "scale124_risk_bucket_downweight_fine_signals"
RUN_DIR = OUT_DIR / "scale124_risk_bucket_downweight_fine"
SUMMARY = OUT_DIR / "scale124_risk_bucket_downweight_fine_summary.csv"
...
CASES = [
    # name, sig5_8_mult, sig_gt8_mult, mid_mv_mult, global_scale, cap
    ("base", 1.00, 1.00, 1.00, 1.00, 0.82),
    ("sig_mid_combo", 0.55, 0.70, 0.65, 1.00, 0.82),
    ("fine_45_60_55_s110", 0.45, 0.60, 0.55, 1.10, 0.82),
    ("fine_45_60_55_s115", 0.45, 0.60, 0.55, 1.15, 0.82),
    ("fine_45_70_55_s110", 0.45, 0.70, 0.55, 1.10, 0.82),
    ("fine_50_65_60_s110", 0.50, 0.65, 0.60, 1.10, 0.82),
    ("fine_55_60_55_s110", 0.55, 0.60, 0.55, 1.10, 0.82),
    ("fine_55_70_55_s105", 0.55, 0.70, 0.55, 1.05, 0.82),
    ("fine_55_70_65_s105", 0.55, 0.70, 0.65, 1.05, 0.82),
    ("fine_55_75_65_s105", 0.55, 0.75, 0.65, 1.05, 0.82),
    ("fine_60_75_60_s105", 0.60, 0.75, 0.60, 1.05, 0.82),
    ("fine_65_75_65_s105", 0.65, 0.75, 0.65, 1.05, 0.82),
    ("fine_45_55_45_s120", 0.45, 0.55, 0.45, 1.20, 0.82),
    ("fine_35_60_55_s120", 0.35, 0.60, 0.55, 1.20, 0.82),
    ("fine_50_80_50_s110", 0.50, 0.80, 0.50, 1.10, 0.82),
    ("fine_55_70_65_s115_cap75", 0.55, 0.70, 0.65, 1.15, 0.75),
    ("fine_50_65_60_s120_cap75", 0.50, 0.65, 0.60, 1.20, 0.75),
    ("fine_45_60_55_s125_cap75", 0.45, 0.60, 0.55, 1.25, 0.75),
]
...
def build_signal(case: tuple[str, float, float, float, float, float]) -> tuple[Path, dict[str, object]]:
    name, sig5_8_mult, sig_gt8_mult, mid_mv_mult, global_scale, cap = case
    ...
    mult.loc[(df["buy_total_mv"] > 300000) & (df["buy_total_mv"] <= 500000)] *= mid_mv_mult
