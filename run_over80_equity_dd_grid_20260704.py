...
RUN_DIR = OUT_DIR / "over80_equity_dd_grid"
SUMMARY = OUT_DIR / "over80_equity_dd_summary.csv"
STRATEGY_DIR = OUT_DIR / "code_snapshot_sell_available_safe"
SIGNAL_FILE = OUT_DIR / "top2_overheat_mv_quality_signals/over80_m50_s116.csv"
SCORE_DB = REPORT_DIR / "score_current.duckdb"
MARKET_DB = ROOT / "quant/data_file/production_assets/duckdb/l2_stock_daily_data.duckdb"


CASES = [
    # name, soft, hard, recover, soft_scale, hard_scale, strict_when_dd, resize_existing
    ("dd_off", None, None, None, None, None, False, False),
    ("dd_08_14_s85_h65", 0.08, 0.14, 0.04, 0.85, 0.65, False, False),
    ("dd_06_10_s70_h50", 0.06, 0.10, 0.03, 0.70, 0.50, False, False),
    ("dd_05_09_s60_h40", 0.05, 0.09, 0.03, 0.60, 0.40, False, False),
    ("dd_06_10_strict", 0.06, 0.10, 0.03, 0.70, 0.50, True, False),
    ("dd_06_10_resize", 0.06, 0.10, 0.03, 0.70, 0.50, False, True),
    ("dd_04_08_s55_h35", 0.04, 0.08, 0.025, 0.55, 0.35, False, True),
]
...
def run_case(case: tuple[str, float | None, float | None, float | None, float | None, float | None, bool, bool]) -> dict[str, object]:
    name, soft, hard, recover, soft_scale, hard_scale, strict, resize = case
        ...
        env.update(
            {
                ...
                "GM_EQUITY_DD_RESIZE_EXISTING": "1" if resize else "0",
            }
        )
    else:
