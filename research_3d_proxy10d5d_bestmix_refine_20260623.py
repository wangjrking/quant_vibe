...
OUT_DIR = DATA_DIR / "reports" / "model_agent_3d_proxy10d5d_bestmix_refine_20260623"
...
CURRENT_TABLE = "stock_predict_data_model_agent_3d_proxy10d5d_bestmix_20260623_executable_3d_open_return_research"
RESEARCH_TABLE = "stock_predict_data_model_agent_3d_proxy10d5d_bestmix_refine_20260623_executable_3d_open_return_research"

LABEL_COL = "executable_3d_open_return"
WEIGHT_GRID = [0.74, 0.76, 0.78, 0.80, 0.82, 0.84, 0.86, 0.88, 0.90]
WINDOWS = {
...
def main() -> int:
    ...
    payload = {
        ...
        "candidate_id": "model_agent_3d_proxy10d5d_bestmix_refine_20260623",
        ...
        "governance_notes": [
            ...
            "refines the 3d bestmix by rescanning the high-10d-weight neighborhood",
            "no training",
    ...
    manifest = {
        ...
        "notes": "3D 研究候选在 bestmix 基础上，对高 10D 权重区间做细扫，选出更优的 rank blend。仅用于研究验证，不进入 formal L4/L5。",
    }
    ...
    report_lines = [
        ...
        f"- 上一版 focus：`{current_focus:.12f}`",
        f"- 新版 focus：`{best_focus:.12f}`",
