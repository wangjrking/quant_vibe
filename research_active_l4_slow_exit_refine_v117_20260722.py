...
OUT = ROOT / "quant/data_file/reports/strategy_agent_active_l4_slow_exit_refine_v117_20260722"
...
def stable_id(definition: dict) -> str:
    ...
    return "v117_" + hashlib.sha256(raw.encode("utf-8")).hexdigest()[:16]


def main() -> None:
    parser = argparse.ArgumentParser(description="慢评分延续策略的卖出阈值研究")
