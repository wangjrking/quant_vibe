...
base.REPORT_DIR = (
    ...
    / "reports"
    / "strategy_agent_goal_high_annual_20260623"
    / "current_formal_flat_capital_efficiency"
)
base.FUSION_DB = base.REPORT_DIR / "fusion_flat_capital_efficiency.db"
base.SCORE_DB = base.REPORT_DIR / "scores_flat_capital_efficiency.db"
...
base.VARIANTS = [
    _cfg("base_flat1322"),
    _cfg("resize_on_signal", extra_env={"GM_RESIZE_HELD_ON_SIGNAL": "1"}),
    _cfg("resize_mult105", extra_env={"GM_RESIZE_HELD_ON_SIGNAL": "1", "GM_RESIZE_HELD_TARGET_MULT": "1.05"}),
    _cfg("resize_mult110", extra_env={"GM_RESIZE_HELD_ON_SIGNAL": "1", "GM_RESIZE_HELD_TARGET_MULT": "1.10"}),
    _cfg("defer_no_signal", extra_env={"GM_DEFER_EXITS_WITHOUT_BUY_SIGNAL": "1", "GM_NO_SIGNAL_MAX_HOLDING_DAYS": "2"}),
    _cfg(
        "defer_no_signal_retband",
        extra_env={
            "GM_DEFER_EXITS_WITHOUT_BUY_SIGNAL": "1",
            "GM_NO_SIGNAL_MAX_HOLDING_DAYS": "2",
            "GM_DEFER_EXIT_MIN_POSITION_RETURN": "-0.08",
            "GM_DEFER_EXIT_MAX_POSITION_RETURN": "0.25",
        },
    ),
    _cfg(
        "resize_and_defer",
