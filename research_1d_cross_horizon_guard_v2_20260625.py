...
REPORT_DIR = DATA_DIR / "reports" / "model_agent_1d_cross_horizon_guard_v2_research_20260625"
TARGET_TABLE = "stock_predict_data_model_agent_1d_cross_horizon_guard_v2_20260625_executable_1d_open_return_research"
...
def scan(scores: pd.DataFrame, labels: pd.DataFrame, features: pd.DataFrame) -> tuple[pd.DataFrame, pd.DataFrame, pd.DataFrame]:
    ...
    rows = []
    daily_rows = []
    alt_sources = ["broad1", "strict1", "cross3", "cross3v3", "cross5", "cross5v2", "cross10", "formal3", "formal5", "formal10"]
