...
OUT = ROOT / "quant/data_file/reports/strategy_agent_active_l4_exit_hold_micro_v146_20260722"
...
def stable_id(definition: dict) -> str:
    ...
    return "v146_" + hashlib.sha256(raw.encode("utf-8")).hexdigest()[:16]


def main() -> None:
    parser = argparse.ArgumentParser(description="正式L4持有期与卖出规则微邻域研究")
