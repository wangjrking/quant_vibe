...
STRATEGY_ID = "candidate_dynamic_h2m3_sl06dd0509_pos94_tp060_v20260624"
...
VALIDATION_DIR = BASE_REPORT_DIR / "dynamic_h2_m3_sl06_dd0509_pos94_tp060_validation_20260624"
POSITION_DIR = BASE_REPORT_DIR / "dynamic_h2_m3_dd0509_tp060_high_position_20260624"
SIGNAL_FILE = POSITION_DIR / "signals" / "dd0509_tp060_pos94.csv"
...
def trading_rules() -> dict:
    return {
        ...
        "strategy_name": "动态持有 Top1 三周期融合 pos94 强风控收益增强候选",
...
def manifest_payload(validation: dict, signal_rows: list[dict]) -> dict:
    ...
    return {
        "schema_version": 1,
        "strategy_id": STRATEGY_ID,
        "name": "动态持有 Top1 三周期融合 pos94 强风控收益增强候选",
        "code_name": "dynamic_h2_m3_c098_w78_5d12_3d10_pos94_e097_mh1_sl06_dd0509_tp060",
        "status": "exploration_candidate_pending_audit_not_published",
        "created_at": "2026-06-24",
        "created_by": "strategy-agent",
        "definition": "formal L4 10D/5D/3D 融合 Top1，目标仓位 94%，动态持有 2-3 日，6% 止损，6% 止盈，账户回撤缩放 soft=5% / hard=9% / scale=0.70/0.50。",
        "validation": {
            "platform": "juejin",
    ...
    return {
        ...
        "strong_gate_precheck": {
            ...
            "parameter_sensitivity": {
                ...
                "chosen_case": "dd0509_tp060_pos94",
                "evidence": "research/high_position_summary.csv",
                "reason": "pos92、pos93、pos94 均低于 40% 回撤；pos95、pos96 越过 40% 回撤红线，pos94 是红线以下最高收益点但安全边际较薄。",
            },
...
def main() -> int:
    ...
    for script in [
        "tune_dynamic_h2_m3_dd0509_tp060_high_position_20260624.py",
        "validate_dynamic_h2_m3_sl06_dd0509_pos94_tp060_20260624.py",
        "archive_dynamic_h2_m3_sl06_dd0509_pos94_tp060_candidate_20260624.py",
    ]:
