...
CASE_NAME = "dynamic_h2_m3_c098_w78_5d12_3d10_pos89_e097_mh1_sl06_dd0712_tp060"
REPORT_DIR = (
    val90.val86.val.SOURCE_DIR
    / "formal_horizon_entry_confirmation_20260624"
    / "dynamic_h2_m3_sl06_dd0712_pos89_tp060_validation_20260624"
)
SIGNAL_FILE = (
    val90.val86.val.SOURCE_DIR
    / "formal_horizon_entry_confirmation_20260624"
...
def _rewrite_report() -> None:
    ...
    lines = [
        ...
        "## 当前结论",
        "",
        f"验证对象：`{CASE_NAME}`。该版本只在已验证的 `dd0712_tp060` 规则上把目标仓位从 `90%` 调整为 `89%`，其余选股、持有、止损止盈、账户回撤缩放和硬过滤口径保持一致。",
        "",
