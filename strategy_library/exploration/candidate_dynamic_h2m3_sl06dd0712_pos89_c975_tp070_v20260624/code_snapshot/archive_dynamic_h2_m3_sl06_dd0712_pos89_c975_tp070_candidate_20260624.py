...
STRATEGY_ID = "candidate_dynamic_h2m3_sl06dd0712_pos89_c975_tp070_v20260624"
...
FINE_DIR = BASE_REPORT_DIR / "dynamic_h2_m3_sl06_dd0712_pos89_c975_fine_neighborhood_20260624"
RULE_DIR = BASE_REPORT_DIR / "dynamic_h2_m3_sl06_dd0712_pos89_rule_neighborhood_20260624"
VALIDATION_DIR = BASE_REPORT_DIR / "dynamic_h2_m3_sl06_dd0712_pos89_c975_tp070_validation_20260624"
STYLE_DIR = RULE_DIR / "style_exposure_audit_20260624"
SIGNAL_FILE = FINE_DIR / "signals" / "c975_tp070.csv"
...
def trading_rules() -> dict:
    ...
    rules["strategy_name"] = "动态持有 Top1 pos89 c975 tp070 收益候选"
    ...
    rules["risk_rule"]["take_profit_pct"] = 0.07
...
def main() -> int:
    ...
    copy_file(FINE_DIR / "summary.csv", ARCHIVE_DIR / "research_grid" / "fine_neighborhood_summary.csv")
    copy_file(FINE_DIR / "summary_by_admission.csv", ARCHIVE_DIR / "research_grid" / "fine_neighborhood_summary_by_admission.csv")
    copy_file(FINE_DIR / "fine_neighborhood_report.md", ARCHIVE_DIR / "research_grid" / "fine_neighborhood_report.md")
    if STRATEGY_MAIN.exists():
        copy_file(STRATEGY_MAIN, ARCHIVE_DIR / "code_snapshot" / "main.py")
    copy_file(
        MAIN / "validate_dynamic_h2_m3_sl06_dd0712_pos89_c975_tp070_20260624.py",
        ARCHIVE_DIR / "code_snapshot" / "validate_dynamic_h2_m3_sl06_dd0712_pos89_c975_tp070_20260624.py",
    )
