...
- 验证对象：`dynamic_h2_m3_c0975_w78_5d12_3d10_pos89_e097_mh1_sl06_dd0712_tp070`。
- 口径：沿用 `pos89/sl06/dd0712/c975` 规则，只把单票止盈从 `6%` 调整为 `7%`。
- 该版本仍是研究验证入口，不修改生产策略、不更新 registry、不生成正式交易信号。
- 全周期年化：`700.07%`；Sharpe：`1.99`；最大回撤：`36.91%`。
- 近期开仓最低年化：`153.78%`。
...
| --- | ---: | ---: | ---: | ---: | ---: |
| full | 700.07% | 1.99 | 36.91% | 201 | 39.20% |
| slice_2024h2 | 356.85% | 1.48 | 32.06% | 55 | 39.62% |
| slice_2025h1 | 123.76% | 1.62 | 28.13% | 40 | 36.20% |
| slice_2025h2 | 210.13% | 2.73 | 15.40% | 57 | 42.49% |
...
| --- | ---: | ---: | ---: | ---: | ---: |
| 20250701 | 7 | 305.10% | 314.15% | 336.15% | 20.69% |
| 20251009 | 7 | 158.51% | 163.83% | 180.61% | 20.68% |
...
| --- | --- | ---: | ---: | ---: | ---: |
| base | 原始信号 | 700.07% | 1.99 | 36.91% | 167.29% |
| drop_top_1pct | 去最高 1% 代理信号 5 条 | 611.20% | 1.95 | 36.91% | 167.29% |
| drop_top_day | 去最高代理信号日 20240925 | 700.07% | 1.99 | 36.91% | 167.29% |
| drop_top_month | 去最高代理月份 202409 | 652.75% | 1.98 | 36.91% | 167.29% |
| drop_top_stock | 去最高代理股票 300573.SZ | 697.59% | 1.99 | 36.91% | 167.29% |
