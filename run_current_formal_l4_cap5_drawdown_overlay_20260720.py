...
OUT = ROOT / "quant" / "data_file" / "reports" / "strategy_agent_current_formal_l4_cap5_drawdown_overlay_20260720"
LOGS = OUT / "logs"
...
CASES = [
    ...
    {"name": "dd_08_14_s85_65", "enabled": True, "soft": 0.08, "hard": 0.14, "recover": 0.04, "soft_scale": 0.85, "hard_scale": 0.65},
...
def run_case(case: dict) -> dict:
    ...
    env.update({
        ...
        "GM_RESIZE_HELD_ON_SIGNAL": "0", "GM_EQUITY_DD_RISK_MODE": "1" if case["enabled"] else "0",
    ...
    return {**case, "returncode": process.returncode, "annual_return": indicator.get("pnl_ratio_annual"), "sharpe": indicator.get("sharp_ratio"), "max_drawdown": indicator.get("max_drawdown"), "win_ratio": indicator.get("win_ratio"), "open_count": indicator.get("open_count"), "close_count": indicator.get("close_count"), "log_file": str(log)}
