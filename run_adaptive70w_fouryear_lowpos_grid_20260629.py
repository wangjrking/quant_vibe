...
EXECS = [
    {
        "name": "hold4m6_c096_e094_ddtight_pos50",
        "holding_days": 4,
        "max_holding_days": 6,
        "continue_ratio": 0.96,
        "exit_ratio": 0.94,
    ...
    {
        "name": "hold4m6_c096_e094_ddtight_pos60",
        "holding_days": 4,
        "max_holding_days": 6,
        "continue_ratio": 0.96,
        "exit_ratio": 0.94,
...
def main() -> None:
    ...
    for entry in ENTRIES:
        for exe in EXECS:
            ...
            mod._write_rows(mod.REPORT_DIR / "adaptive70w_fouryear_lowpos_detail.csv", detail_rows)
            mod._write_rows(mod.REPORT_DIR / "adaptive70w_fouryear_lowpos_summary.csv", summary_rows)
