...
def main() -> None:
    parser = argparse.ArgumentParser(description="导出 V165 冻结候选的掘金动作")
    ...
    for case_id in args.case_id:
        ...
        daily, actions = v162.run_case(arrays, score, order, definition, protocol, args.end_date, record_actions=True)
