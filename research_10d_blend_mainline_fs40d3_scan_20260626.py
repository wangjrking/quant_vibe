...
REPORT_DIR = DATA_DIR / "reports" / "model_agent_research_10d_blend_mainline_fs40d3_scan_20260626"

LABEL = "executable_10d_open_return"
MAINLINE_TABLE = "stock_predict_data_model_agent_10d_risk_balanced_v5_shrink_20260625_executable_10d_open_return_research"
FS40_PATH = (
    DATA_DIR
    / "reports"
...
def main() -> int:
    ...
    for weight_main in weights:
        ...
        daily["weight_fs40d3"] = weight_fs40
    ...
    delta_rows = []
    for row in rows:
        for baseline_name, base in [("mainline", baseline), ("fs40_d3_l8", fs40_base)]:
    ...
    packet = {
        ...
        "scope": "research_only_10d_mainline_fs40d3_blend_scan",
        "label": LABEL,
