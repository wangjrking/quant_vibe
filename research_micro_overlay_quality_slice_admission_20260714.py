...
SIGNAL_DIR = REPORT_DIR / "signals" / "micro_overlay_quality_slice_admission"
LOG_DIR = REPORT_DIR / "logs" / "micro_overlay_quality_slice_admission"
OUT_CSV = REPORT_DIR / "micro_overlay_quality_slice_admission_juejin_results_20260714.csv"
OUT_JSON = REPORT_DIR / "micro_overlay_quality_slice_admission_juejin_results_20260714.json"
REPORT_MD = REPORT_DIR / "微仓质量增强候选切片准入复核_20260714.md"
...
CANDIDATES = {
    "bl_empty_p1hi_sigmid_s015": SOURCE_DIR / "bl_empty_p1hi_sigmid_s015.csv",
    "bl_empty_sigmid_s012": SOURCE_DIR / "bl_empty_sigmid_s012.csv",
}
...
def write_report(frame: pd.DataFrame) -> None:
    lines = [
        ...
        "## 结论",
        "",
        "- 本报告只检查刚新增的质量增强候选，不发布生产。",
        "- 判断重点是 2025、2026、2025-2026 独立启动表现是否仍明显低于全周期。",
        "",
        "## 掘金切片结果",
        "",
    ...
    for _, row in frame.sort_values(["case", "slice"]).iterrows():
        lines.append(
