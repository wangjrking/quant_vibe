...
OUT_DIR = REPORT_DIR / "variants_lowgap_adaptive_quality_fine5"
RUN_DIR = REPORT_DIR / "juejin_runs_lowgap_adaptive_quality_fine5"
SUMMARY_CSV = REPORT_DIR / "juejin_lowgap_adaptive_quality_fine5_summary.csv"
RAW_CSV = REPORT_DIR / "juejin_lowgap_adaptive_quality_fine5_raw.csv"
MANIFEST_CSV = REPORT_DIR / "variants_lowgap_adaptive_quality_fine5_manifest.csv"


# name, add for signal_pct_chg (0,2], add for >2, add for <=-2, add for (-2,0], atr24 add
CASES = [
    ("j01_s30_p00_n03_z03_a18", 0.30, 0.00, -0.03, 0.03, -0.18),
    ("j02_s30_p08_n03_z03_a18", 0.30, 0.08, -0.03, 0.03, -0.18),
    ("j03_s34_p04_n03_z03_a18", 0.34, 0.04, -0.03, 0.03, -0.18),
    ("j04_s38_p04_n03_z03_a18", 0.38, 0.04, -0.03, 0.03, -0.18),
    ("j05_s30_p04_n03_z03_a14", 0.30, 0.04, -0.03, 0.03, -0.14),
    ("j06_s30_p04_n03_z03_a22", 0.30, 0.04, -0.03, 0.03, -0.22),
    ("j07_s34_p04_n03_z03_a14", 0.34, 0.04, -0.03, 0.03, -0.14),
    ("j08_s34_p04_n03_z03_a22", 0.34, 0.04, -0.03, 0.03, -0.22),
]
