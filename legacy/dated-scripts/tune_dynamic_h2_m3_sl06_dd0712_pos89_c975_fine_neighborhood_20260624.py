...
REPORT_DIR = BASE_DIR / "dynamic_h2_m3_sl06_dd0712_pos89_c975_fine_neighborhood_20260624"
SOURCE_SIGNAL = (
    BASE_DIR
...
BASE_CASE = {
    "case_name": "base_c975_pos89_tp060_sl060_dd0712",
    "target_pct": 0.89,
    "exit_ratio": 0.970,
...
CASES = [
    BASE_CASE,
    {**BASE_CASE, "case_name": "c970", "continue_ratio": 0.970},
    {**BASE_CASE, "case_name": "c9725", "continue_ratio": 0.9725},
    {**BASE_CASE, "case_name": "c9775", "continue_ratio": 0.9775},
    {**BASE_CASE, "case_name": "c980", "continue_ratio": 0.980},
    {**BASE_CASE, "case_name": "c975_tp065", "take_profit": 0.065},
    {**BASE_CASE, "case_name": "c975_tp070", "take_profit": 0.070},
    {**BASE_CASE, "case_name": "c975_tp075", "take_profit": 0.075},
    {**BASE_CASE, "case_name": "c975_sl055", "stop_loss": 0.055},
    {**BASE_CASE, "case_name": "c975_sl065", "stop_loss": 0.065},
    {**BASE_CASE, "case_name": "c975_pos88", "target_pct": 0.88},
    {**BASE_CASE, "case_name": "c975_pos90", "target_pct": 0.90},
    {**BASE_CASE, "case_name": "c975_pos91", "target_pct": 0.91},
    {**BASE_CASE, "case_name": "c975_dd0813", "dd_soft": 0.080, "dd_hard": 0.130},
    {**BASE_CASE, "case_name": "c975_dd0611", "dd_soft": 0.060, "dd_hard": 0.110},
    {**BASE_CASE, "case_name": "c975_scale060040", "dd_soft_scale": 0.60, "dd_hard_scale": 0.40},
    {**BASE_CASE, "case_name": "c975_scale080060", "dd_soft_scale": 0.80, "dd_hard_scale": 0.60},
    {**BASE_CASE, "case_name": "c9725_tp070", "continue_ratio": 0.9725, "take_profit": 0.070},
    {**BASE_CASE, "case_name": "c9775_tp070", "continue_ratio": 0.9775, "take_profit": 0.070},
    {**BASE_CASE, "case_name": "c975_pos90_tp070", "target_pct": 0.90, "take_profit": 0.070},
]
...
def _write_report(summary: list[dict], audit: dict) -> None:
    ...
    for row in ranked:
        params = (
            f"pos={_f(row['target_pct']):.2%}, c={_f(row['continue_ratio']):.4f}, "
            f"sl={_f(row['stop_loss']):.2%}, tp={_f(row['take_profit']):.2%}, "
    ...
    (REPORT_DIR / "fine_neighborhood_report.md").write_text("\n".join(lines) + "\n", encoding="utf-8")
