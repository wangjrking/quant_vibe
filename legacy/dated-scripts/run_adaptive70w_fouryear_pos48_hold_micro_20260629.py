...
OUT_DIR = DATA / "reports" / "strategy_agent_adaptive70w_fouryear_pos48_hold_micro_20260629"
...
HOLD_CASES = [
    ...
    {
        "name": "h4m5_c096_e095_dd96",
        "holding_days": 4,
        "max_holding_days": 5,
        "score_continue_ratio": 0.96,
        "score_exit_ratio": 0.95,
        "min_score_exit_days": 1,
        "day_drop_ratio": 0.96,
    },
    {
        "name": "h4m6_c097_e095_dd96",
        "holding_days": 4,
        "max_holding_days": 6,
        "score_continue_ratio": 0.97,
        "score_exit_ratio": 0.95,
    ...
    {
        "name": "h4m6_c096_e094_dd96",
        "holding_days": 4,
        "max_holding_days": 6,
        "score_continue_ratio": 0.96,
        "score_exit_ratio": 0.94,
        "min_score_exit_days": 1,
        "day_drop_ratio": 0.96,
    },
]
...
def main() -> None:
    ...
    for case in HOLD_CASES:
        ...
        _write_rows(OUT_DIR / "hold_micro_detail.csv", detail)
        _write_rows(OUT_DIR / "hold_micro_summary.csv", summary)
