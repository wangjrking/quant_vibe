...
REPORT_DIR = BASE_DIR / "dynamic_h2_m3_tp060_position_20260624"
BASE_SIGNAL_FILE = BASE_DIR / "dynamic_h2_m3_pos76_takeprofit_20260624" / "signals" / "pos76_sl06_dd0612_tp060.csv"
...
TARGET_PCTS = [0.68, 0.72, 0.74, 0.76, 0.78, 0.80, 0.82, 0.84]
...
def _case_name(target_pct: float) -> str:
    return f"tp060_pos{int(round(target_pct * 100)):02d}"
...
def _signal_for_case(target_pct: float) -> Path:
    ...
    for row in rows:
        ...
        row["strategy_variant"] = f"dynamic_h2_m3_tp060_pos{target_pct:.2f}"
