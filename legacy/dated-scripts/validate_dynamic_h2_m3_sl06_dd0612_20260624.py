...
CASE_NAME = "dynamic_h2_m3_c098_w78_5d12_3d10_pos56_e097_mh1_sl06_dd0612"
SOURCE_DIR = liq.SOURCE_DIR / "strict_sync_liquidity_neighborhood_20260624"
REPORT_DIR = SOURCE_DIR / "formal_horizon_entry_confirmation_20260624" / "dynamic_h2_m3_sl06_dd0612_validation_20260624"
...
def _write_report(time_rows: list[dict], nearby_summary: list[dict], stress_summary: list[dict], proxy_stats: dict, audit: dict) -> None:
    lines = [
        "# dynamic h2_m3_c098 + sl06_dd0612 完整验证",
        "",
        "## 当前结论",
        "",
        f"验证对象：`{CASE_NAME}`。该版本在 dynamic h2_m3_c098 基础上增加日内 `6%` 止损，以及账户回撤缩放 `soft=6% / hard=12% / scale=0.80/0.60`。",
        "",
