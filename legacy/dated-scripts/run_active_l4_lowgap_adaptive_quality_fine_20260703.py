...
OUT_DIR = REPORT_DIR / "variants_lowgap_adaptive_quality_fine"
RUN_DIR = REPORT_DIR / "juejin_runs_lowgap_adaptive_quality_fine"
SUMMARY_CSV = REPORT_DIR / "juejin_lowgap_adaptive_quality_fine_summary.csv"
RAW_CSV = REPORT_DIR / "juejin_lowgap_adaptive_quality_fine_raw.csv"
MANIFEST_CSV = REPORT_DIR / "variants_lowgap_adaptive_quality_fine_manifest.csv"


# name, add for signal_pct_chg (0,2], add for >2, add for <=-2, add for (-2,0], atr24 add
CASES = [
    ("f01_s14_p12_n03_z03_a18", 0.14, -0.12, -0.03, 0.03, -0.18),
    ("f02_s16_p12_n03_z03_a18", 0.16, -0.12, -0.03, 0.03, -0.18),
    ("f03_s18_p12_n03_z03_a18", 0.18, -0.12, -0.03, 0.03, -0.18),
    ("f04_s14_p10_n03_z03_a18", 0.14, -0.10, -0.03, 0.03, -0.18),
    ("f05_s16_p10_n03_z03_a18", 0.16, -0.10, -0.03, 0.03, -0.18),
    ("f06_s14_p08_n03_z03_a18", 0.14, -0.08, -0.03, 0.03, -0.18),
    ("f07_s14_p12_n00_z03_a18", 0.14, -0.12, 0.00, 0.03, -0.18),
    ("f08_s14_p12_n03_z06_a18", 0.14, -0.12, -0.03, 0.06, -0.18),
]
