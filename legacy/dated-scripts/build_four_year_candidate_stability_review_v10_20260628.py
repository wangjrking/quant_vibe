...
REPORT_DIR = DATA_DIR / "reports" / "model_agent_four_year_candidate_stability_review_v10_20260628"
...
SPECS = {
    ...
    "3d": {
        ...
        "asset": "research_3d_four_year_active_clear_gate_hybrid_20260628",
        "eval_summary": DATA_DIR
        / "reports"
        / "model_agent_four_year_3d_active_clear_gate_hybrid_20260628"
        / "standard_eval"
        / "executable_3d_open_return_four_year_active_clear_gate_hybrid_20260628_eval_summary.json",
        "monthly_delta": DATA_DIR
        / "reports"
        / "model_agent_four_year_3d_active_clear_gate_hybrid_20260628"
        / "standard_eval"
        / "executable_3d_open_return_four_year_active_clear_gate_hybrid_20260628_vs_four_year_control_3d_monthly_delta.csv",
        "daily_delta": DATA_DIR
        / "reports"
        / "model_agent_four_year_3d_active_clear_gate_hybrid_20260628"
        / "standard_eval"
        / "executable_3d_open_return_four_year_active_clear_gate_hybrid_20260628_daily_eval.csv",
    },
    "5d": {
        ...
        / "model_agent_four_year_5d_active_clear_gate_hybrid_20260628"
        / "standard_eval"
        / "executable_5d_open_return_four_year_active_clear_gate_hybrid_20260628_vs_four_year_control_5d_monthly_delta.csv",
        "daily_delta": DATA_DIR
        / "reports"
        / "model_agent_four_year_5d_active_clear_gate_hybrid_20260628"
        / "standard_eval"
    ...
    "10d": {
        ...
        "asset": "research_10d_four_year_active_recent_gate_hybrid_v2_20260628",
        "eval_summary": DATA_DIR
        / "reports"
        / "model_agent_four_year_10d_active_recent_gate_hybrid_v2_20260628"
        / "standard_eval"
        / "executable_10d_open_return_four_year_active_recent_gate_hybrid_v2_20260628_eval_summary.json",
        "monthly_delta": DATA_DIR
        / "reports"
        / "model_agent_four_year_10d_active_recent_gate_hybrid_v2_20260628"
        / "standard_eval"
        / "executable_10d_open_return_four_year_active_recent_gate_hybrid_v2_20260628_vs_four_year_control_10d_monthly_delta.csv",
        "daily_delta": DATA_DIR
        / "reports"
        / "model_agent_four_year_10d_active_recent_gate_hybrid_v2_20260628"
        / "standard_eval"
        / "executable_10d_open_return_four_year_active_recent_gate_hybrid_v2_20260628_daily_eval.csv",
    },
}
...
def summarize_one(key: str, spec: dict[str, object]) -> tuple[dict[str, object], pd.DataFrame, pd.DataFrame]:
    ...
    control_daily = DATA_DIR / "reports" / "model_agent_four_year_control_assets_20260627" / "standard_eval" / f"{spec['label']}_four_year_control_daily_eval.csv"
...
def main() -> int:
    ...
    summary_df.to_csv(REPORT_DIR / "candidate_stability_summary_v10.csv", index=False, encoding="utf-8-sig")

    summary = {
        "generated_at": now_iso(),
        "scope": "four_year_current_best_candidate_stability_review_v10",
    ...
    (REPORT_DIR / "candidate_stability_summary_v10.json").write_text(json.dumps(summary, ensure_ascii=False, indent=2), encoding="utf-8")
    ...
    (REPORT_DIR / "candidate_stability_review_v10.md").write_text("\n".join(lines) + "\n", encoding="utf-8")
