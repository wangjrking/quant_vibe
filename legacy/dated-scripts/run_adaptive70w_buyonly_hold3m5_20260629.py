...
CASES = [
    ("w75_20_05_hold3m5_c096e095_pos80", "w75_20_05_amt90_mv20__hold3m5_c096_e095_ddtight_pos80", 0.80, 0.96, 0.95),
    ("w80_15_05_hold3m5_c096e095_pos80", "w80_15_05_amt90_mv20__hold3m5_c096_e095_ddtight_pos80", 0.80, 0.96, 0.95),
    ("w75_20_05_hold3m5_c096e095_pos90", "w75_20_05_amt90_mv20__hold3m5_c096_e095_ddtight", 0.90, 0.96, 0.95),
    ("w80_15_05_hold3m5_c096e095_pos90", "w80_15_05_amt90_mv20__hold3m5_c096_e095_ddtight", 0.90, 0.96, 0.95),
]
...
def _run(case_name: str, stem: str, target_pct: float, cont: float, exit_ratio: float, tag: str, start: str, end: str) -> dict[str, Any]:
    ...
    if indicator is None:
        env = os.environ.copy()
        env.update(BASE_ENV)
        env["GM_SCORE_CONTINUE_ENTRY_RATIO"] = f"{cont:.2f}"
        env["GM_SCORE_EXIT_ENTRY_RATIO"] = f"{exit_ratio:.2f}"
        cmd = [
            str(JUEJIN_PYTHON),
...
def main() -> None:
    ...
    for case_name, stem, target_pct, cont, exit_ratio in CASES:
        rows = [_run(case_name, stem, target_pct, cont, exit_ratio, tag, start, end) for tag, start, end in SLICES]
        detail.extend(rows)
        out = {
            "case": case_name,
        ...
        _write_rows(REPORT_DIR / "adaptive70w_buyonly_hold3m5_detail.csv", detail)
        _write_rows(REPORT_DIR / "adaptive70w_buyonly_hold3m5_summary.csv", summary)
