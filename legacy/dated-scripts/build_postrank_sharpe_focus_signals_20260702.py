...
OUT_DIR = BASE_DIR / "postrank_open_filter_candidates" / "sharpe_focus_candidates"
SIGNAL_FILE = BASE_DIR / "w25_25_00_50_gapm8p3_top8" / "signals.csv"
MARKET_DB = ROOT / "quant" / "data_file" / "production_assets" / "duckdb" / "l2_stock_daily_data.duckdb"


CASES = [
    {"name": "lowflat_pct8_top5", "gap_low": -0.05, "gap_high": 0.0, "pct_cap": 8.0, "keep_topn": 5},
    {"name": "nohigh_pct12_top8", "gap_low": -0.08, "gap_high": 0.01, "pct_cap": 12.0, "keep_topn": 8},
    {"name": "nohigh_pct8_top8", "gap_low": -0.08, "gap_high": 0.01, "pct_cap": 8.0, "keep_topn": 8},
    {"name": "mildlow_pct8_top8", "gap_low": -0.03, "gap_high": 0.01, "pct_cap": 8.0, "keep_topn": 8},
    {"name": "mildlow_pct8_top5", "gap_low": -0.03, "gap_high": 0.01, "pct_cap": 8.0, "keep_topn": 5},
]
...
def main() -> int:
    ...
    pd.DataFrame(manifest).to_csv(OUT_DIR / "candidate_manifest.csv", index=False, encoding="utf-8")
