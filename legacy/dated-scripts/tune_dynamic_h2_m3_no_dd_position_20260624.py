...
REPORT_DIR = BASE_DIR / "dynamic_h2_m3_no_dd_position_20260624"
...
TARGET_PCTS = [0.58, 0.62, 0.66, 0.70, 0.72, 0.74, 0.76]
...
def _case_name(target_pct: float) -> str:
    return f"no_dd_pos{int(round(target_pct * 100)):02d}_sl06"
...
def _signal_for_case(target_pct: float) -> Path:
    ...
    for row in rows:
        ...
        row["strategy_variant"] = f"dynamic_h2_m3_no_dd_pos{target_pct:.2f}_sl06"
