...
OUT = ROOT / "quant" / "data_file" / "reports" / "strategy_agent_current_formal_l4_cap5_best_validation_20260720"
MODULE.OUT = OUT
MODULE.LOGS = OUT / "logs"
MODULE.SIGNAL = ROOT / "quant" / "data_file" / "reports" / "strategy_agent_current_formal_l4_cap5_rank_hold_refine_20260720" / "signals" / "r1_88_min12_max13.csv"
...
def main() -> None:
    ...
    (OUT / "result.json").write_text(
        json.dumps({"status": "research_only", "signal_file": str(MODULE.SIGNAL), "results": rows}, ensure_ascii=False, indent=2), encoding="utf-8"
    )
