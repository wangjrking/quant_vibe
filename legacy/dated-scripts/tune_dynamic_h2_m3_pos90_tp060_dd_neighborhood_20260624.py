...
REPORT_DIR = BASE_DIR / "dynamic_h2_m3_pos90_tp060_dd_neighborhood_20260624"
BASE_SIGNAL_FILE = BASE_DIR / "dynamic_h2_m3_dd0611_tp060_position_20260624" / "signals" / "dd0611_tp060_pos90.csv"

TARGET_PCT = 0.90
DD_CASES = [
    {"case_name": "tp060_pos90_dd0510_s7050", "risk_mode": 1, "soft": 0.05, "hard": 0.10, "recover": 0.03, "soft_scale": 0.70, "hard_scale": 0.50},
    {"case_name": "tp060_pos90_dd0510_s7555", "risk_mode": 1, "soft": 0.05, "hard": 0.10, "recover": 0.03, "soft_scale": 0.75, "hard_scale": 0.55},
    {"case_name": "tp060_pos90_dd0610_s7050", "risk_mode": 1, "soft": 0.06, "hard": 0.10, "recover": 0.03, "soft_scale": 0.70, "hard_scale": 0.50},
    {"case_name": "tp060_pos90_dd0611_s7050", "risk_mode": 1, "soft": 0.06, "hard": 0.11, "recover": 0.03, "soft_scale": 0.70, "hard_scale": 0.50},
    {"case_name": "tp060_pos90_dd0611_s7555", "risk_mode": 1, "soft": 0.06, "hard": 0.11, "recover": 0.03, "soft_scale": 0.75, "hard_scale": 0.55},
    {"case_name": "tp060_pos90_dd0612_s7050", "risk_mode": 1, "soft": 0.06, "hard": 0.12, "recover": 0.03, "soft_scale": 0.70, "hard_scale": 0.50},
    {"case_name": "tp060_pos90_dd0712_s7050", "risk_mode": 1, "soft": 0.07, "hard": 0.12, "recover": 0.03, "soft_scale": 0.70, "hard_scale": 0.50},
]
...
def _signal_for_case(case: dict) -> Path:
    ...
    for row in rows:
        ...
        row["strategy_variant"] = f"dynamic_h2_m3_pos90_{case['case_name']}"
    _write_rows(path, rows)
    return path


def _run(case: dict, signal_file: Path, start_name: str, start: str, end: str) -> dict:
    old_report = dd.REPORT_DIR
    old_base = dd.BASE_SIGNAL_FILE
    old_target = dd.TARGET_PCT
    try:
        dd.REPORT_DIR = REPORT_DIR
        dd.BASE_SIGNAL_FILE = BASE_SIGNAL_FILE
        dd.TARGET_PCT = TARGET_PCT
        return dd._run(case, signal_file, start_name, start, end)
    finally:
        dd.REPORT_DIR = old_report
        dd.BASE_SIGNAL_FILE = old_base
        dd.TARGET_PCT = old_target
