...
OUT_DIR = REPORT_DIR / "variants_lowgap_adaptive_quality_fine2"
RUN_DIR = REPORT_DIR / "juejin_runs_lowgap_adaptive_quality_fine2"
SUMMARY_CSV = REPORT_DIR / "juejin_lowgap_adaptive_quality_fine2_summary.csv"
RAW_CSV = REPORT_DIR / "juejin_lowgap_adaptive_quality_fine2_raw.csv"
MANIFEST_CSV = REPORT_DIR / "variants_lowgap_adaptive_quality_fine2_manifest.csv"


# name, add for signal_pct_chg (0,2], add for >2, add for <=-2, add for (-2,0], atr24 add
CASES = [
    ("g01_s14_p06_n03_z03_a18", 0.14, -0.06, -0.03, 0.03, -0.18),
    ("g02_s14_p04_n03_z03_a18", 0.14, -0.04, -0.03, 0.03, -0.18),
    ("g03_s14_p00_n03_z03_a18", 0.14, 0.00, -0.03, 0.03, -0.18),
    ("g04_s18_p08_n03_z03_a18", 0.18, -0.08, -0.03, 0.03, -0.18),
    ("g05_s18_p06_n03_z03_a18", 0.18, -0.06, -0.03, 0.03, -0.18),
    ("g06_s20_p08_n03_z03_a18", 0.20, -0.08, -0.03, 0.03, -0.18),
    ("g07_s22_p08_n03_z03_a18", 0.22, -0.08, -0.03, 0.03, -0.18),
    ("g08_s20_p06_n03_z03_a18", 0.20, -0.06, -0.03, 0.03, -0.18),
]
