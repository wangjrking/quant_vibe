...
ENTRIES = [
    ...
    {"name": "w78_17_05_amt150_mv30", "w10d": 0.78, "w5d": 0.17, "w3d": 0.05, "amount_min": 150000.0, "total_mv_min": 300000.0},
    {"name": "w70_25_05_amt200_mv50", "w10d": 0.70, "w5d": 0.25, "w3d": 0.05, "amount_min": 200000.0, "total_mv_min": 500000.0},
    {"name": "w72_23_05_amt200_mv50", "w10d": 0.72, "w5d": 0.23, "w3d": 0.05, "amount_min": 200000.0, "total_mv_min": 500000.0},
    {"name": "w75_20_05_amt200_mv50", "w10d": 0.75, "w5d": 0.20, "w3d": 0.05, "amount_min": 200000.0, "total_mv_min": 500000.0},
]

EXECS = [
    {
        "name": "hold4m6_c096_e094_ddtight_pos65",
        "holding_days": 4,
        "max_holding_days": 6,
        "continue_ratio": 0.96,
        "exit_ratio": 0.94,
...
def main() -> None:
    ...
    detail_rows = mod._read_rows(mod.REPORT_DIR / "adaptive70w_fouryear_liquidity_detail.csv") if hasattr(mod, "_read_rows") else []
    summary_rows = []
    for entry in ENTRIES:
        for exe in EXECS:
            ...
            mod._write_rows(mod.REPORT_DIR / "adaptive70w_fouryear_liquidity_detail.csv", detail_rows)
            mod._write_rows(mod.REPORT_DIR / "adaptive70w_fouryear_liquidity_summary.csv", summary_rows)
