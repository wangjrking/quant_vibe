...
EXECS = [
    {
        "name": "hold3m5_c096_e095_ddtight_pos65",
        "holding_days": 3,
        "max_holding_days": 5,
        "continue_ratio": 0.96,
        "exit_ratio": 0.95,
    ...
    {
        "name": "hold3m5_c097_e096_ddtight_pos65",
        "holding_days": 3,
        "max_holding_days": 5,
        "continue_ratio": 0.97,
        "exit_ratio": 0.96,
...
def main() -> None:
    ...
    for entry in ENTRIES:
        for exe in EXECS:
            ...
            mod._write_rows(mod.REPORT_DIR / "adaptive70w_fouryear_liq_exit_detail.csv", detail_rows)
            mod._write_rows(mod.REPORT_DIR / "adaptive70w_fouryear_liq_exit_summary.csv", summary_rows)
