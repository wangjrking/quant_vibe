...
import research_active_l4_v252_regime_positions_v258_20260723 as v258
...
OUT = (
    ROOT
    / "quant/data_file/reports/strategy_agent_active_l4_v258_paths_v259_20260723"
)
...
def main() -> None:
    ...
    summary.to_csv(
        OUT / "path_summary.csv", index=False, encoding="utf-8-sig"
    )
