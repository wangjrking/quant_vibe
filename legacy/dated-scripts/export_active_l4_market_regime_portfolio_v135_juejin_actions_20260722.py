...
import research_active_l4_market_regime_portfolio_v135_20260722 as v135
...
def main() -> None:
    parser = argparse.ArgumentParser(description="导出 V135 冻结候选的掘金动作")
    ...
    for case_id in args.case_id:
        ...
        daily, actions = v109.simulate(
            arrays,
            score,
            order,
            definition,
            v135.case_protocol(protocol, definition),
            args.end_date,
            record_actions=True,
