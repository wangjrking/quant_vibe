...
base.REPORT_DIR = (
    ...
    / "reports"
    / "strategy_agent_goal_high_annual_20260623"
    / "current_formal_top1keep_continue_only"
)
base.FUSION_DB = base.REPORT_DIR / "fusion_top1keep_continue_only.db"
base.SCORE_DB = base.REPORT_DIR / "scores_top1keep_continue_only.db"
    ...
    *,
    ...
    return {
        ...
        "top1_rule": {
            ...
            "score_continue_entry_ratio": top1_continue_ratio,
            "holding_days": 5,
        ...
        "env": {
            ...
            "GM_SCORE_CONTINUE_ENTRY_RATIO": "2.0",
        },
    }


base.VARIANTS = [
    _cfg("top1c099_x7_r091", top1_exit_ratio=0.91, top1_continue_ratio=0.99, max_holding_days=7),
    _cfg("top1c098_x7_r091", top1_exit_ratio=0.91, top1_continue_ratio=0.98, max_holding_days=7),
    _cfg("top1c100_x7_r091", top1_exit_ratio=0.91, top1_continue_ratio=1.00, max_holding_days=7),
    _cfg("top1c099_x8_r091", top1_exit_ratio=0.91, top1_continue_ratio=0.99, max_holding_days=8),
    _cfg("top1c098_x8_r091", top1_exit_ratio=0.91, top1_continue_ratio=0.98, max_holding_days=8),
    _cfg("top1c100_x8_r091", top1_exit_ratio=0.91, top1_continue_ratio=1.00, max_holding_days=8),
    _cfg("top1c099_x9_r091", top1_exit_ratio=0.91, top1_continue_ratio=0.99, max_holding_days=9),
    _cfg("top1c098_x9_r091", top1_exit_ratio=0.91, top1_continue_ratio=0.98, max_holding_days=9),
    _cfg("top1c099_x8_r090", top1_exit_ratio=0.90, top1_continue_ratio=0.99, max_holding_days=8),
    _cfg("top1c099_x8_r092", top1_exit_ratio=0.92, top1_continue_ratio=0.99, max_holding_days=8),
]
...
def _build_signals(cfg: dict) -> list[dict]:
    ...
    for row in rows:
        ...
        signal = {
            ...
            "holding_days": 5,
            "max_holding_days": int(cfg["env"]["GM_MAX_HOLDING_DAYS"]),
        }
        if rank == 1:
