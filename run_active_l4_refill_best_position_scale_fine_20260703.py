...
OUT_DIR = REPORT_DIR / "variants_refill_best_position_scale_fine"
RUN_DIR = REPORT_DIR / "juejin_runs_refill_best_position_scale_fine"
RAW_CSV = REPORT_DIR / "juejin_refill_best_position_scale_fine_raw.csv"
SUMMARY_CSV = REPORT_DIR / "juejin_refill_best_position_scale_fine_summary.csv"


CASES = [
    ("scale121_cap80", 1.21, 0.80),
    ("scale122_cap80", 1.22, 0.80),
    ("scale123_cap80", 1.23, 0.80),
    ("scale124_cap80", 1.24, 0.80),
    ("scale125_cap80", 1.25, 0.80),
    ("scale122_cap82", 1.22, 0.82),
    ("scale124_cap82", 1.24, 0.82),
]
