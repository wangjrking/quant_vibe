...
OUT_DIR = DATA_DIR / "reports" / "model_agent_10d_std035_local_reblend_1dbest_20260623"
...
RESEARCH_TABLE = "stock_predict_data_model_agent_10d_std035_local_reblend_1dbest_20260623_executable_10d_open_return_research"
...
def main() -> int:
    ...
    manifest = {
        ...
        "label": LABEL_COL,
        "candidate_id": "model_agent_10d_std035_local_reblend_1dbest_20260623",
        ...
        "notes": "10D research 候选以当前 std035 最优候选为底座，只在极窄头部区域叠加 1D best 排序，检查 1D 是否能继续提升 10D 头部质量。不进入 formal L4/L5。",
    }
    ...
    lines = [
        "# 10D std035 局部叠加 1D best 研究候选",
        "",
        "## 当前结论",
        "",
        f"- 当前 10D 最优候选：`{BASE_TABLE}`",
