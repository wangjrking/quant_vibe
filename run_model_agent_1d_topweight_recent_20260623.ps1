...
$env:XGB_SAMPLE_WEIGHT_TOP_MULTIPLIER = "8.0"
...
$out = "../data_file/reports/model_agent_research_1d_topweight_recent_20260623"
...
& $python run_parallel_expanding2010_folds.py `
  ...
  --output-table stock_predict_data_model_agent_research_1d_topweight_recent_20260623 `
  --output-dir $out `
  --experiment-name xgb_reg1d_topweight_recent_20260623 `
  --start-fold 8 `
  --end-fold 9 `
  --max-workers 1 `
  --xgb-device cuda `
