...
$OutputDir = Join-Path $ProjectRoot "quant\data_file\reports\model_agent_research_1d_next_20260622"
...
& $Python run_parallel_expanding2010_folds.py `
  ...
  --output-table stock_predict_data_model_agent_research_1d_next_20260622 `
  --output-dir ../data_file/reports/model_agent_research_1d_next_20260622 `
  --experiment-name xgb_reg1d_research_next_20260622 `
  --max-workers 1 `
  --xgb-device cuda `
  --xgb-n-jobs 0 `
