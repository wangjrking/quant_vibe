...
REPORT_DIR = DATA_DIR / "reports" / "model_agent_5d_cross_horizon_guard_research_20260625"
TARGET_TABLE = "stock_predict_data_model_agent_5d_cross_horizon_guard_20260625_executable_5d_open_return_research"
...
def scan(scores: pd.DataFrame, labels: pd.DataFrame, features: pd.DataFrame) -> tuple[pd.DataFrame, pd.DataFrame, pd.DataFrame]:
    ...
    rows = []
    daily_rows = []
    alt_sources = ["dyn5", "strict5", "formal10", "dyn10", "cross10", "formal3", "cross3", "strict1"]
