...
STRATEGY_ID = "candidate_dynamic_h2m3_sl06dd0612_pos76_v20260624"
...
VALIDATION_DIR = BASE_REPORT_DIR / "dynamic_h2_m3_sl06_dd0612_pos76_validation_20260624"
POSITION_DIR = BASE_REPORT_DIR / "dynamic_h2_m3_sl06_dd0612_position_20260624"
SIGNAL_FILE = POSITION_DIR / "signals" / "sl06_dd0612_pos76.csv"
STRATEGY_MAIN = (
...
def _copy_evidence_files() -> None:
    _copy(SIGNAL_FILE, ARCHIVE_DIR / "signals" / "historical_sl06_dd0612_pos76.csv")
    ...
    for script in [
        ...
        "validate_dynamic_h2_m3_sl06_dd0612_pos76_20260624.py",
...
def _build_trading_rules() -> dict:
    return {
        ...
        "strategy_name": "动态持有 Top1 三周期融合 pos76",
...
def _build_validation(summary: dict, audit: dict) -> dict:
    ...
    return {
        ...
        "evidence": {
            ...
            "historical_signals": "signals/historical_sl06_dd0612_pos76.csv",
        },
    }
...
def _build_reproduction() -> dict:
    return {
        ...
        "python_commands": [
            ...
            ".venv\\Scripts\\python.exe quant\\main\\validate_dynamic_h2_m3_sl06_dd0612_pos76_20260624.py",
        ],
...
def _build_manifest(summary: dict, latest: dict) -> dict:
    ...
    return {
        "schema_version": 1,
        "strategy_id": STRATEGY_ID,
        "name": "动态持有 Top1 三周期融合 pos76",
        "code_name": "dynamic_h2_m3_c098_w78_5d12_3d10_pos76_e097_mh1_sl06_dd0612",
        "status": "production_candidate_pending_audit_not_published",
        "created_at": "2026-06-24",
        "created_by": "strategy-agent",
        "definition": "基于 formal L4 10D/5D/3D 资产，按 0.78*10D rank + 0.12*5D rank + 0.10*3D rank 选 Top1，目标仓位 76%，动态持有 2-3 日，日内 6% 止损，并启用账户回撤缩放。",
        "input_contract": {
            "source_mode": "formal_l4_3d5d10d_only",
            "approval_required": "approved_for_l5",
            "legacy_odb_forbidden_by_default": True,
