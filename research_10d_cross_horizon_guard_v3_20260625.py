...
REPORT_DIR = DATA_DIR / "reports" / "model_agent_10d_cross_horizon_guard_v3_research_20260625"
TARGET_TABLE = "stock_predict_data_model_agent_10d_cross_horizon_guard_v3_20260625_executable_10d_open_return_research"
...
def write_outputs(scan_result: pd.DataFrame, daily: pd.DataFrame, source_metrics: pd.DataFrame, stats: dict | None) -> None:
    ...
    lines = ["# 10D 跨周期动态守卫 v3 研究报告（20260625）", "", "## 当前结论", ""]
    if stats:
        lines.extend(
            [
