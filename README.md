...
项目默认运行在本机 Python 与 DuckDB 环境中。Docker 和云中心部署包仅供可选部署使用，不是日常工作流的前提。
...
| 可选云中心部署 | [deploy/cloud-center/README.md](deploy/cloud-center/README.md) |
