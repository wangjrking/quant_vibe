...
REPORT_DIR = DATA_DIR / "reports" / "model_agent_research_3d_gate_refine_fullwindow_20260626"
...
def main() -> int:
    ...
    summary = {
        ...
        "scope": "research_only_3d_fullwindow_gate_refine",
