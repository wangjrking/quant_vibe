...
REPORT_DIR = BASE_DIR / "dynamic_h2_m3_dd0712_tp060_position_20260624"
BASE_SIGNAL_FILE = BASE_DIR / "dynamic_h2_m3_pos90_tp060_dd_neighborhood_20260624" / "signals" / "tp060_pos90_dd0712_s7050.csv"
...
TARGET_PCTS = [0.86, 0.88, 0.89, 0.90, 0.91, 0.92, 0.93, 0.94, 0.95]
...
def _case_name(target_pct: float) -> str:
    return f"dd0712_tp060_pos{int(round(target_pct * 100)):02d}"
...
def _signal_for_case(target_pct: float) -> Path:
    ...
    for row in rows:
        ...
        row["strategy_variant"] = f"dynamic_h2_m3_dd0712_tp060_pos{target_pct:.2f}"
