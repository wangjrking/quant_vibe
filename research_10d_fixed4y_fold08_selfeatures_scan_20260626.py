...
REPORT_DIR = DATA_DIR / "reports" / "model_agent_research_10d_fixed4y_fold08_selfeatures_scan_20260626"
...
def run_candidate(candidate: Candidate) -> dict:
    ...
    command = [
        ...
        "--output-table",
        f"stock_predict_data_model_agent_{candidate.name}_fold08_20260626",
...
def main() -> int:
    ...
    packet = {
        ...
        "scope": "research_only_10d_fixed4y_fold08_selfeatures_scan",
        "label": LABEL,
