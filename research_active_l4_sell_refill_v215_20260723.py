...
OUT = ROOT / "quant/data_file/reports/strategy_agent_active_l4_sell_refill_v215_20260723"
...
def stable_id(definition: dict) -> str:
    ...
    return "v215_" + hashlib.sha256(raw.encode("utf-8")).hexdigest()[:16]
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Active L4 卖出后多候选补位研究")
