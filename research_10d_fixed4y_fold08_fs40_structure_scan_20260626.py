...
REPORT_DIR = DATA_DIR / "reports" / "model_agent_research_10d_fixed4y_fold08_fs40_structure_scan_20260626"
...
CANDIDATES = [
    Candidate("fs40_ref", 4, 4.0, 0.0, 0.003, 6000, False),
    Candidate("fs40_d3_l8", 3, 8.0, 0.1, 0.003, 6000, True),
    Candidate("fs40_d3_l12", 3, 12.0, 0.2, 0.003, 6000, True),
    Candidate("fs40_d2_l12", 2, 12.0, 0.2, 0.003, 6000, True),
    Candidate("fs40_d3_l8_lr004_n5000", 3, 8.0, 0.1, 0.004, 5000, True),
]
...
def main() -> int:
    ...
    for candidate in CANDIDATES:
        ...
        for baseline_name in ["research10d_current", "formal10d_current", "fs40_ref"]:
    ...
    packet = {
        ...
        "scope": "research_only_10d_fixed4y_fold08_fs40_structure_scan",
        "label": LABEL,
        ...
        "baselines": {**BASELINE_TABLES, "fs40_ref": str(FS40_BASE_PREDICTION)},
    }
