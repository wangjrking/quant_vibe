...
REPORT_DIR = DATA / "reports" / "strategy_agent_prod_amt9p5w_dd_trigger_micro_20260625"

CASES = [
    {
        "case_name": "amt9p5_pos8975_s7353_dd065_115",
    ...
    {
        "case_name": "amt9p5_pos8975_s7353_dd07_115",
        "signal_file": DATA / "reports" / "strategy_agent_prod_filter_amount_interpolate_20260625" / "signals" / "prod_filter_amt9p5w_mv20w.csv",
        "target_pct": 0.8975,
        "dd_soft_scale": 0.73,
        "dd_hard_scale": 0.53,
    ...
    {
        "case_name": "amt9p5_pos8975_s7353_dd075_115",
        "signal_file": DATA / "reports" / "strategy_agent_prod_filter_amount_interpolate_20260625" / "signals" / "prod_filter_amt9p5w_mv20w.csv",
        "target_pct": 0.8975,
        "dd_soft_scale": 0.73,
        "dd_hard_scale": 0.53,
    ...
    {
        "case_name": "amt9p5_pos8975_s7555_dd065_115",
        "signal_file": DATA / "reports" / "strategy_agent_prod_filter_amount_interpolate_20260625" / "signals" / "prod_filter_amt9p5w_mv20w.csv",
        "target_pct": 0.8975,
        "dd_soft_scale": 0.75,
        "dd_hard_scale": 0.55,
    ...
    {
        "case_name": "amt9p5_pos8975_s7555_dd07_115",
        "signal_file": DATA / "reports" / "strategy_agent_prod_filter_amount_interpolate_20260625" / "signals" / "prod_filter_amt9p5w_mv20w.csv",
        "target_pct": 0.8975,
        "dd_soft_scale": 0.75,
        "dd_hard_scale": 0.55,
    ...
    {
        "case_name": "amt9p5_pos8975_s7555_dd075_115",
        "signal_file": DATA / "reports" / "strategy_agent_prod_filter_amount_interpolate_20260625" / "signals" / "prod_filter_amt9p5w_mv20w.csv",
        "target_pct": 0.8975,
        "dd_soft_scale": 0.75,
        "dd_hard_scale": 0.55,
