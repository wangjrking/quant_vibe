...
REPORT_DIR = BASE_DIR / "dynamic_h2_m3_pos76_dd_neighborhood_20260624"
...
DD_CASES = [
    ...
    {
        "case_name": "pos76_sl06_dd0510_s8060",
        "risk_mode": 1,
        "soft": 0.05,
        "hard": 0.10,
        "recover": 0.03,
    ...
    {
        "case_name": "pos76_sl06_dd0612_s8060",
        "risk_mode": 1,
        "soft": 0.06,
        "hard": 0.12,
        "recover": 0.03,
    ...
    {
        "case_name": "pos76_sl06_dd0612_s8565",
        "risk_mode": 1,
        "soft": 0.06,
        "hard": 0.12,
        "recover": 0.03,
    ...
    {
        "case_name": "pos76_sl06_dd0714_s8060",
        "risk_mode": 1,
        "soft": 0.07,
        "hard": 0.14,
        "recover": 0.04,
    ...
    {
        "case_name": "pos76_sl06_dd0814_s8565",
        "risk_mode": 1,
        "soft": 0.08,
        "hard": 0.14,
        "recover": 0.04,
...
def _signal_for_case(case: dict) -> Path:
    ...
    for row in rows:
        ...
        row["strategy_variant"] = f"dynamic_h2_m3_pos76_sl06_{case['case_name']}"
