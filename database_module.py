...
SELECT
    ...
    t3.name,
    T1.open AS open,
    T1.open*T7.adj_factor/T8.adj_factor AS open_qfq,
    T1.close AS close,
    T1.close*T7.adj_factor/T8.adj_factor AS close_qfq,
    T1.high AS high,
    T1.high*T7.adj_factor/T8.adj_factor AS high_qfq,
    T1.low AS low,
    T1.low*T7.adj_factor/T8.adj_factor AS low_qfq,
    T1.pre_close AS pre_close,
    T1.pre_close*T7.adj_factor/T8.adj_factor AS pre_close_qfq,
    T1.change,
    T1.pct_chg,
    T1.vol,
    T1.amount,
