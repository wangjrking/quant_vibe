...
REPORT_DIR = DATA_DIR / "reports" / "model_agent_1d_exante_score_state_asset_v67_20260627"
SCAN_DIR = DATA_DIR / "reports" / "model_agent_1d_exante_score_state_gate_v66_20260627"
BASE_TABLE = "stock_predict_data_model_agent_1d_daygate_best_20260627_executable_1d_open_return_research"
CAND_TABLE = "stock_predict_data_model_agent_1d_top5_safe_gate_v59_20260627_executable_1d_open_return_research"
TARGET_TABLE = "stock_predict_data_model_agent_1d_exante_iqr_gate_v67_20260627_executable_1d_open_return_research"
FEATURE = "base_score_iqr"
THRESHOLD = 0.499907754183
...
def main() -> int:
    ...
    summary_path = SCAN_DIR / "exante_score_state_gate_summary.json"
    scan_summary = json.loads(summary_path.read_text(encoding="utf-8"))
    summary = {
        "generated_at": now_iso(),
        "scope": "research_only_1d_exante_iqr_gate_v67_asset",
        "label": "executable_1d_open_return",
        "base_table": BASE_TABLE,
        "candidate_table": CAND_TABLE,
        "target_table": TARGET_TABLE,
        "formula": f"use candidate pred_prob when {FEATURE} >= {THRESHOLD}; otherwise base pred_prob",
