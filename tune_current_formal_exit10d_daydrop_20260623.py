...
base.REPORT_DIR = (
    ...
    / "reports"
    / "strategy_agent_goal_high_annual_20260623"
    / "current_formal_exit10d_daydrop"
)
base.FUSION_DB = base.REPORT_DIR / "fusion_exit10d_daydrop.db"
base.SCORE_DB = base.REPORT_DIR / "scores_exit10d_daydrop.db"


def _cfg(name: str, *, day_drop_ratio: str | None = None, exit_ratio: str = "0.94") -> dict:
    env = {
...
base.VARIANTS = [
    _cfg("base_exit10d"),
    _cfg("daydrop0999", day_drop_ratio="0.999"),
    _cfg("daydrop0998", day_drop_ratio="0.998"),
    _cfg("daydrop0997", day_drop_ratio="0.997"),
    _cfg("daydrop0995", day_drop_ratio="0.995"),
    _cfg("daydrop0999_exit0938", day_drop_ratio="0.999", exit_ratio="0.938"),
    _cfg("daydrop0998_exit0938", day_drop_ratio="0.998", exit_ratio="0.938"),
    _cfg("daydrop0999_exit0942", day_drop_ratio="0.999", exit_ratio="0.942"),
]
