...
base.REPORT_DIR = (
    ...
    / "reports"
    / "strategy_agent_goal_high_annual_20260623"
    / "current_formal_flat_maxsells"
)
base.FUSION_DB = base.REPORT_DIR / "fusion_flat_maxsells.db"
base.SCORE_DB = base.REPORT_DIR / "scores_flat_maxsells.db"


def _cfg(name: str, *, max_sells: int, exit_ratio: str = "0.94", exit_rank: str | None = "0.94") -> dict:
    env = {
        "GM_OPEN_DAILY_SCORE_EXIT": "1",
        "GM_SCORE_EXIT_ENTRY_RATIO": str(exit_ratio),
        "GM_MIN_HOLDING_DAYS_BEFORE_SCORE_EXIT": "2",
        "GM_MAX_DAILY_SELLS": str(max_sells),
    }
...
base.VARIANTS = [
    _cfg("maxsell1", max_sells=1),
    _cfg("maxsell2", max_sells=2),
    _cfg("maxsell3", max_sells=3),
    _cfg("maxsell4", max_sells=4),
    _cfg("maxsell2_exit093", max_sells=2, exit_ratio="0.93"),
    _cfg("maxsell2_norank", max_sells=2, exit_rank=None),
    _cfg("maxsell3_exit093", max_sells=3, exit_ratio="0.93"),
    _cfg("maxsell3_norank", max_sells=3, exit_rank=None),
]
