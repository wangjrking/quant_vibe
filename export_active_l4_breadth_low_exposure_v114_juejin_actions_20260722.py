...
import research_active_l4_breadth_low_exposure_v114_20260722 as v114
...
def main() -> None:
    parser = argparse.ArgumentParser(description="导出 V114 冻结候选的掘金动作")
    ...
    for case_id in args.case_id:
        ...
        current = v114.case_protocol(protocol, definition)
