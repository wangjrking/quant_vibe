...
STRATEGY_ID = "candidate_dynamic_h2m3_sl06dd0611_pos86_tp060_v20260624"
...
VALIDATION_DIR = BASE_REPORT_DIR / "dynamic_h2_m3_sl06_dd0611_pos86_tp060_validation_20260624"
MIDPOINT_DIR = BASE_REPORT_DIR / "dynamic_h2_m3_pos86_tp060_dd_midpoint_20260624"
SIGNAL_FILE = MIDPOINT_DIR / "signals" / "tp060_pos86_dd0611_s7050.csv"
...
def trading_rules() -> dict:
    return {
        ...
        "strategy_name": "动态持有 Top1 三周期融合 pos86 收益增强候选",
...
def validation_payload(summary: dict) -> dict:
    ...
    return {
        ...
        "strong_admission_status": {
            ...
            "residual_risks": [
                "recent60 年化低于更保守的 dd0509_s7050，属于收益增强与近期持续性之间的取舍。",
...
def main() -> int:
    ...
    copy_file(MIDPOINT_DIR / "summary.csv", ARCHIVE_DIR / "research_grid" / "dd_midpoint_summary.csv")
    copy_file(MIDPOINT_DIR / "dd_midpoint_report.md", ARCHIVE_DIR / "research_grid" / "dd_midpoint_report.md")
