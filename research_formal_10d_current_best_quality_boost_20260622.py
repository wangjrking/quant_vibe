...
VARIANTS = [
    _variant("repro", [], cap=0.42),
    _variant("pred16_b130_same", [{"field": "pred_10d", "op": "ge", "threshold": 0.16, "scale": 1.30}]),
    _variant("pred16_b150_same", [{"field": "pred_10d", "op": "ge", "threshold": 0.16, "scale": 1.50}], cap=0.52),
    _variant("turn1_b115_same", [{"field": "turnover_rate", "op": "lt", "threshold": 1.0, "scale": 1.15}]),
    _variant("turn1_b130_same", [{"field": "turnover_rate", "op": "lt", "threshold": 1.0, "scale": 1.30}], cap=0.52),
    _variant("amount1w_b115_same", [{"field": "amount", "op": "lt", "threshold": 10000.0, "scale": 1.15}]),
    _variant("amount1w_b130_same", [{"field": "amount", "op": "lt", "threshold": 10000.0, "scale": 1.30}], cap=0.52),
    _variant("mv8w_b115_same", [{"field": "total_mv", "op": "lt", "threshold": 80000.0, "scale": 1.15}]),
    _variant("mv8w_b130_same", [{"field": "total_mv", "op": "lt", "threshold": 80000.0, "scale": 1.30}], cap=0.52),
    _variant("quality_combo_soft_same", [
        {"field": "pred_10d", "op": "ge", "threshold": 0.16, "scale": 1.25},
        {"field": "turnover_rate", "op": "lt", "threshold": 1.0, "scale": 1.12},
        {"field": "amount", "op": "lt", "threshold": 10000.0, "scale": 1.12},
        {"field": "total_mv", "op": "lt", "threshold": 80000.0, "scale": 1.10},
    ], cap=0.52),
    _variant("quality_combo_mid_same", [
        {"field": "pred_10d", "op": "ge", "threshold": 0.16, "scale": 1.40},
        {"field": "turnover_rate", "op": "lt", "threshold": 1.0, "scale": 1.20},
        {"field": "amount", "op": "lt", "threshold": 10000.0, "scale": 1.20},
        {"field": "total_mv", "op": "lt", "threshold": 80000.0, "scale": 1.15},
    ], cap=0.55),
    _variant("quality_combo_soft_grow", [
        {"field": "pred_10d", "op": "ge", "threshold": 0.16, "scale": 1.25},
        {"field": "turnover_rate", "op": "lt", "threshold": 1.0, "scale": 1.12},
        {"field": "amount", "op": "lt", "threshold": 10000.0, "scale": 1.12},
        {"field": "total_mv", "op": "lt", "threshold": 80000.0, "scale": 1.10},
    ], cap=0.52, normalize="grow", max_day_sum_mult=1.06),
    _variant("quality_combo_mid_grow", [
        {"field": "pred_10d", "op": "ge", "threshold": 0.16, "scale": 1.40},
        {"field": "turnover_rate", "op": "lt", "threshold": 1.0, "scale": 1.20},
        {"field": "amount", "op": "lt", "threshold": 10000.0, "scale": 1.20},
        {"field": "total_mv", "op": "lt", "threshold": 80000.0, "scale": 1.15},
    ], cap=0.55, normalize="grow", max_day_sum_mult=1.08),
    _variant("quality_combo_hard_grow", [
        {"field": "pred_10d", "op": "ge", "threshold": 0.16, "scale": 1.60},
        {"field": "turnover_rate", "op": "lt", "threshold": 1.0, "scale": 1.30},
        {"field": "amount", "op": "lt", "threshold": 10000.0, "scale": 1.30},
        {"field": "total_mv", "op": "lt", "threshold": 80000.0, "scale": 1.20},
    ], cap=0.58, normalize="grow", max_day_sum_mult=1.10),
    _variant("quality_plus_rank2_grow", [
        {"field": "pred_10d", "op": "ge", "threshold": 0.16, "scale": 1.30},
        {"field": "turnover_rate", "op": "lt", "threshold": 1.0, "scale": 1.15},
        {"field": "amount", "op": "lt", "threshold": 10000.0, "scale": 1.15},
        {"field": "rank", "op": "le", "threshold": 2.0, "scale": 1.06},
    ], cap=0.55, normalize="grow", max_day_sum_mult=1.08),
    _variant("quality_plus_bad_down_same", [
        {"field": "pred_10d", "op": "ge", "threshold": 0.16, "scale": 1.35},
        {"field": "turnover_rate", "op": "lt", "threshold": 1.0, "scale": 1.20},
        {"field": "amount", "op": "lt", "threshold": 10000.0, "scale": 1.20},
        {"field": "rank", "op": "ge", "threshold": 4.0, "scale": 0.94},
        {"field": "pred_gap", "op": "ge", "threshold": 0.08, "scale": 0.94},
    ], cap=0.55),
    _variant("quality_plus_bad_down_grow", [
        {"field": "pred_10d", "op": "ge", "threshold": 0.16, "scale": 1.35},
        {"field": "turnover_rate", "op": "lt", "threshold": 1.0, "scale": 1.20},
        {"field": "amount", "op": "lt", "threshold": 10000.0, "scale": 1.20},
        {"field": "rank", "op": "ge", "threshold": 4.0, "scale": 0.94},
    ...
    _variant("mv8w_b120_same", [{"field": "total_mv", "op": "lt", "threshold": 80000.0, "scale": 1.20}], cap=0.50),
    _variant("mv8w_b125_same", [{"field": "total_mv", "op": "lt", "threshold": 80000.0, "scale": 1.25}], cap=0.50),
    _variant("mv8w_b135_same", [{"field": "total_mv", "op": "lt", "threshold": 80000.0, "scale": 1.35}], cap=0.54),
    _variant("mv8w_b130_strict", [{"field": "total_mv", "op": "lt", "threshold": 80000.0, "scale": 1.30}], cap=0.52, eqdd="strict"),
    _variant("mv8w_b130_base", [{"field": "total_mv", "op": "lt", "threshold": 80000.0, "scale": 1.30}], cap=0.52, eqdd="base"),
    _variant("mv8w_b130_dd_hard", [{"field": "total_mv", "op": "lt", "threshold": 80000.0, "scale": 1.30}], cap=0.52, extra_env={
        "GM_EQUITY_DD_SOFT_TRIGGER": "0.07",
        "GM_EQUITY_DD_HARD_TRIGGER": "0.14",
        "GM_EQUITY_DD_SOFT_SCALE": "0.78",
        "GM_EQUITY_DD_HARD_SCALE": "0.50",
    }),
    _variant("turn1_b110_same", [{"field": "turnover_rate", "op": "lt", "threshold": 1.0, "scale": 1.10}], cap=0.46),
    _variant("turn1_b112_same", [{"field": "turnover_rate", "op": "lt", "threshold": 1.0, "scale": 1.12}], cap=0.46),
    _variant("turn1_b118_same", [{"field": "turnover_rate", "op": "lt", "threshold": 1.0, "scale": 1.18}], cap=0.48),
    _variant("mv8w_b120_turn1_b110", [
        {"field": "total_mv", "op": "lt", "threshold": 80000.0, "scale": 1.20},
        {"field": "turnover_rate", "op": "lt", "threshold": 1.0, "scale": 1.10},
    ], cap=0.52),
    _variant("mv8w_b125_turn1_b112", [
        {"field": "total_mv", "op": "lt", "threshold": 80000.0, "scale": 1.25},
        {"field": "turnover_rate", "op": "lt", "threshold": 1.0, "scale": 1.12},
    ], cap=0.54),
    _variant("mv8w_b120_pred16_b120", [
        {"field": "total_mv", "op": "lt", "threshold": 80000.0, "scale": 1.20},
        {"field": "pred_10d", "op": "ge", "threshold": 0.16, "scale": 1.20},
    ], cap=0.52),
]
...
def _write_signal(cfg: dict, signal_file: Path) -> dict:
    ...
    for field in ["quality_boost_scale", "quality_boost_source_target"]:
    ...
    for row in rows:
        ...
        row["quality_boost_source_target"] = f"{base_target:.5f}"
        row["quality_boost_scale"] = f"{scale:.6f}"
    ...
    for day, day_rows in grouped.items():
        ...
        if abs(target_sum - current_sum) < 1e-12:
            continue
