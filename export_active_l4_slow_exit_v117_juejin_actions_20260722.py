...
def main() -> None:
    parser = argparse.ArgumentParser(description="导出 V117 冻结候选的掘金动作")
    ...
    for case_id in args.case_id:
        ...
        daily, actions = v109.simulate(arrays, score, order, definition, protocol, args.end_date, record_actions=True)
