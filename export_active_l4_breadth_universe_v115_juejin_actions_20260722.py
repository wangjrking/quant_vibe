...
import research_active_l4_breadth_universe_v115_20260722 as v115
...
def main() -> None:
    parser = argparse.ArgumentParser(description="导出 V115 冻结候选的掘金动作")
    ...
    for case_id in args.case_id:
        ...
        current = v115.case_protocol(protocol, definition)
