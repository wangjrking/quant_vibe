...
OUT_DIR = DATA_DIR / "reports" / "model_agent_5d_daily_gate_d3d1_20260623"
...
RESEARCH_TABLE = "stock_predict_data_model_agent_5d_daily_gate_d3d1_20260623_executable_5d_open_return_research"
...
def main() -> int:
    ...
    payload = {
        ...
        "candidate_id": "model_agent_5d_daily_gate_d3d1_20260623",
    ...
    manifest = {
        ...
        "notes": "5D 研究候选自 20250301 起按日门控：若当前 5D base top5 在 3D 排序中的平均分位低于 0.99，则整日切到 3D；否则若在 1D 排序中的平均分位低于 0.996，则整日切到 1D；其余日期保持 base。仅用于 research 验证，不进入 formal L4/L5。",
    }
