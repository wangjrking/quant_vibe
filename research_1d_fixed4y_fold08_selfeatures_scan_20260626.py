...
FEATURES_PATH = (
    DATA_DIR
    / "reports"
    / "model_agent_1d_tune_20260621"
    / "xgb_reg1d_fixed3y_d2_l12_fs64_lr006_n3500_topfront_gate7_20260621"
    / "feature_scores"
    / "xgb_reg1d_fixed3y_d2_l12_fs64_lr006_n3500_topfront_gate7_20260621"
    / "selected_features_executable_1d_open_return_rolling_fold8.json"
)
REPORT_DIR = DATA_DIR / "reports" / "model_agent_research_1d_fixed4y_fold08_selfeatures_scan_20260626"
...
CANDIDATES = [
    Candidate("self_ref", 5, 126, 0.007, 7.0, 3500, 0.006, 2, 12.0, 0.0),
    Candidate("self_top3_reg16", 3, 84, 0.005, 10.0, 3200, 0.006, 2, 16.0, 0.2),
    Candidate("self_top5_lr004", 5, 126, 0.005, 8.0, 4200, 0.004, 2, 12.0, 0.1),
]
...
def run_candidate(candidate: Candidate) -> dict:
    ...
    command = [
        ...
        "--output-table",
        f"stock_predict_data_model_agent_{candidate.name}_1d_fold08_20260626",
...
def main() -> int:
        ...
        summary.update(
            {
                ...
                "model_path": str(out_dir(candidate) / "fold08" / "models" / "model_fold08.json"),
    ...
    packet = {
        ...
        "scope": "research_only_1d_fixed4y_fold08_selfeatures_scan",
        "label": LABEL,
