...
REPORT_DIR = (
    ...
    / "reports"
    / "strategy_agent_model_application_20260621"
    / "formal_5d10d_regime_filter_refine_20260621"
)
BASE_SIGNAL = SOURCE_DIR / "signals" / "base_h7_tp10925.csv"
SCORE_DB = SOURCE_DIR / "pool_exec_scores.db"
SCORE_TABLE = "base_h7_tp10925_prank_10d90_5d10_plim2_pmv150000p0_frank_10d60_5d40_fmv200000p0_atrnone"
...
VARIANTS = [
    ...
    {"name": "weak_primary_scale085", "rules": [{"type": "weak_primary", "scale": 0.85, "primary_count_max": 1}]},
    {"name": "weak_primary_scale080", "rules": [{"type": "weak_primary", "scale": 0.80, "primary_count_max": 1}]},
    {"name": "weak_primary_scale075", "rules": [{"type": "weak_primary", "scale": 0.75, "primary_count_max": 1}]},
    {
        "name": "weak075_strong101",
        "rules": [
            {"type": "weak_primary", "scale": 0.75, "primary_count_max": 1},
            {"type": "strong_primary", "scale": 1.01, "primary_count_min": 2},
        ],
        "max_target_pct": BASE_TARGET * 1.01,
    },
    {
        "name": "weak075_strong102",
        "rules": [
            {"type": "weak_primary", "scale": 0.75, "primary_count_max": 1},
    ...
    {
        "name": "weak080_strong101",
        "rules": [
            {"type": "weak_primary", "scale": 0.80, "primary_count_max": 1},
            {"type": "strong_primary", "scale": 1.01, "primary_count_min": 2},
        ],
        "max_target_pct": BASE_TARGET * 1.01,
    },
    {
        "name": "weak085_strong101",
        "rules": [
            {"type": "weak_primary", "scale": 0.85, "primary_count_max": 1},
            {"type": "strong_primary", "scale": 1.01, "primary_count_min": 2},
        ],
        "max_target_pct": BASE_TARGET * 1.01,
    },
    {"name": "weak_fallback_only_scale085", "rules": [{"type": "weak_fallback_only", "scale": 0.85, "primary_count_max": 1}]},
    {"name": "weak_fallback_only_scale080", "rules": [{"type": "weak_fallback_only", "scale": 0.80, "primary_count_max": 1}]},
    {"name": "weak_avgpred_scale075", "rules": [{"type": "weak_avg_pred", "scale": 0.75, "avg_pred_lt": 2.25}]},
    {"name": "weak_combined_scale070", "rules": [{"type": "weak_combined", "scale": 0.70, "primary_count_max": 1, "avg_pred_lt": 2.25}]},
    {"name": "weak_fallback_only_scale070", "rules": [{"type": "weak_fallback_only", "scale": 0.70, "primary_count_max": 1}]},
    ...
    {
        "name": "idx_or_weak_scale075",
        "rules": [
            {"type": "idx_or_weak", "scale": 0.75, "idx_ret_5_lt": -0.03, "primary_count_max": 1, "avg_pred_lt": 2.25}
        ],
    },
    {
        "name": "idx_or_weak_scale060",
        "rules": [
            {"type": "idx_or_weak", "scale": 0.60, "idx_ret_5_lt": -0.03, "primary_count_max": 1, "avg_pred_lt": 2.25}
        ],
    },
    {
