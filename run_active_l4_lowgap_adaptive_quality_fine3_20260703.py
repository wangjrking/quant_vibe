...
OUT_DIR = REPORT_DIR / "variants_lowgap_adaptive_quality_fine3"
RUN_DIR = REPORT_DIR / "juejin_runs_lowgap_adaptive_quality_fine3"
SUMMARY_CSV = REPORT_DIR / "juejin_lowgap_adaptive_quality_fine3_summary.csv"
RAW_CSV = REPORT_DIR / "juejin_lowgap_adaptive_quality_fine3_raw.csv"
MANIFEST_CSV = REPORT_DIR / "variants_lowgap_adaptive_quality_fine3_manifest.csv"


# name, add for signal_pct_chg (0,2], add for >2, add for <=-2, add for (-2,0], atr24 add
CASES = [
    ("h01_s14_p04_n03_z03_a18", 0.14, 0.04, -0.03, 0.03, -0.18),
    ("h02_s14_p08_n03_z03_a18", 0.14, 0.08, -0.03, 0.03, -0.18),
    ("h03_s14_p12_n03_z03_a18", 0.14, 0.12, -0.03, 0.03, -0.18),
    ("h04_s20_p00_n03_z03_a18", 0.20, 0.00, -0.03, 0.03, -0.18),
    ("h05_s20_p04_n03_z03_a18", 0.20, 0.04, -0.03, 0.03, -0.18),
    ("h06_s20_p08_n03_z03_a18", 0.20, 0.08, -0.03, 0.03, -0.18),
    ("h07_s24_p00_n03_z03_a18", 0.24, 0.00, -0.03, 0.03, -0.18),
    ("h08_s24_p04_n03_z03_a18", 0.24, 0.04, -0.03, 0.03, -0.18),
]
