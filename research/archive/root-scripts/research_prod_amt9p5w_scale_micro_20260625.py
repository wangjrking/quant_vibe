...
REPORT_DIR = DATA / "reports" / "strategy_agent_prod_amt9p5w_scale_micro_20260625"

CASES = [
    {
        "case_name": "amt9p5_pos895_s7353",
        "signal_file": DATA / "reports" / "strategy_agent_amt9p5w_true_target_20260625" / "pos895.csv",
        "target_pct": 0.895,
        "dd_soft_scale": 0.73,
        "dd_hard_scale": 0.53,
    },
    {
        "case_name": "amt9p5_pos895_s7454",
        "signal_file": DATA / "reports" / "strategy_agent_amt9p5w_true_target_20260625" / "pos895.csv",
        "target_pct": 0.895,
        "dd_soft_scale": 0.74,
        "dd_hard_scale": 0.54,
    ...
    {
        "case_name": "amt9p5_pos8975_s7353",
    ...
    {
        "case_name": "amt9p5_pos8975_s7454",
        "signal_file": DATA / "reports" / "strategy_agent_prod_filter_amount_interpolate_20260625" / "signals" / "prod_filter_amt9p5w_mv20w.csv",
        "target_pct": 0.8975,
        "dd_soft_scale": 0.74,
        "dd_hard_scale": 0.54,
    ...
    {
        "case_name": "amt9p5_pos8975_s7555",
        "signal_file": DATA / "reports" / "strategy_agent_prod_filter_amount_interpolate_20260625" / "signals" / "prod_filter_amt9p5w_mv20w.csv",
        "target_pct": 0.8975,
        "dd_soft_scale": 0.75,
        "dd_hard_scale": 0.55,
