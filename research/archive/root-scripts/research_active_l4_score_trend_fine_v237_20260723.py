...
import research_active_l4_score_trend_sensitivity_v236_20260723 as v236
import research_preregistered_active_l4_rank_rotation_20260721 as core


ROOT = Path(__file__).resolve().parents[2]
OUT = ROOT / "quant/data_file/reports/strategy_agent_active_l4_score_trend_fine_v237_20260723"
...
def stable_id(definition: dict) -> str:
    ...
    return "v237_" + hashlib.sha256(raw.encode("utf-8")).hexdigest()[:16]


def main() -> None:
    parser = argparse.ArgumentParser(description="Fine score-trend sensitivity research")
