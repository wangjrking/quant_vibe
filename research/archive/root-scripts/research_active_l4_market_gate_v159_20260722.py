...
OUT = ROOT / "quant/data_file/reports/strategy_agent_active_l4_market_gate_v159_20260722"
...
def stable_id(definition: dict) -> str:
    ...
    return "v159_" + hashlib.sha256(raw.encode("utf-8")).hexdigest()[:16]


def main() -> None:
    parser = argparse.ArgumentParser(description="正式L4市场状态边界研究")
    ...
    rows, definitions = [], {}
    for market_min in protocol["grid"]["market_return_min"]:
        definition = {**protocol["fixed_definition"], "market_return_min": market_min}
