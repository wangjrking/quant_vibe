...
OUT = ROOT / "quant/data_file/reports/strategy_agent_active_l4_exit_hold_refine_v144_20260722"
...
def stable_id(definition: dict) -> str:
    ...
    return "v144_" + hashlib.sha256(raw.encode("utf-8")).hexdigest()[:16]


def main() -> None:
    parser = argparse.ArgumentParser(description="正式L4策略持有期与独立卖出规则研究")
