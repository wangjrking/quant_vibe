...
OUT = ROOT / "quant/data_file/reports/strategy_agent_active_l4_long_hold_allocation_v150_20260722"
...
def stable_id(definition: dict) -> str:
    ...
    return "v150_" + hashlib.sha256(raw.encode("utf-8")).hexdigest()[:16]


def main() -> None:
    parser = argparse.ArgumentParser(description="正式L4长持有策略仓位研究")
