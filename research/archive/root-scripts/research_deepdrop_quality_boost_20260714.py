...
SIGNAL_DIR = REPORT_DIR / "signals" / "deepdrop_quality_boost"
LOG_DIR = REPORT_DIR / "logs" / "deepdrop_quality_boost"
OUT_CSV = REPORT_DIR / "deepdrop_quality_boost_juejin_results_20260714.csv"
OUT_JSON = REPORT_DIR / "deepdrop_quality_boost_juejin_results_20260714.json"
...
CASES = [
    {"case": "dqb_x86_g1075_q2b102", "deep_scale": 0.86, "global_scale": 1.075, "q2_boost": 1.02, "q1_boost": 1.00},
    {"case": "dqb_x86_g1075_q2b103", "deep_scale": 0.86, "global_scale": 1.075, "q2_boost": 1.03, "q1_boost": 1.00},
    {"case": "dqb_x86_g1075_q2b104", "deep_scale": 0.86, "global_scale": 1.075, "q2_boost": 1.04, "q1_boost": 1.00},
    {"case": "dqb_x86_g1075_q2b105", "deep_scale": 0.86, "global_scale": 1.075, "q2_boost": 1.05, "q1_boost": 1.00},
    {"case": "dqb_x86_g1070_q2b105", "deep_scale": 0.86, "global_scale": 1.070, "q2_boost": 1.05, "q1_boost": 1.00},
    {"case": "dqb_x86_g1075_q12b102", "deep_scale": 0.86, "global_scale": 1.075, "q2_boost": 1.02, "q1_boost": 1.02},
    {"case": "dqb_x86_g1075_q12b103", "deep_scale": 0.86, "global_scale": 1.075, "q2_boost": 1.03, "q1_boost": 1.02},
    {"case": "dqb_x87_g1070_q2b103", "deep_scale": 0.87, "global_scale": 1.070, "q2_boost": 1.03, "q1_boost": 1.00},
    {"case": "dqb_x87_g1070_q2b104", "deep_scale": 0.87, "global_scale": 1.070, "q2_boost": 1.04, "q1_boost": 1.00},
    {"case": "dqb_x87_g1075_q2b102", "deep_scale": 0.87, "global_scale": 1.075, "q2_boost": 1.02, "q1_boost": 1.00},
]
...
def write_variant(source: pd.DataFrame, case: dict) -> dict:
    ...
    scale = scale.mask(q2_mask, scale * float(case["q2_boost"]))
    ...
    df["quality_q2_boost"] = float(case["q2_boost"])
    df["quality_q1_boost"] = float(case["q1_boost"])
