...
OUT = ROOT / "quant/data_file/reports/strategy_agent_active_l4_allocation_refine_v147_20260722"
...
def stable_id(definition: dict) -> str:
    ...
    return "v147_" + hashlib.sha256(raw.encode("utf-8")).hexdigest()[:16]


def main() -> None:
    parser = argparse.ArgumentParser(description="正式L4策略仓位配置窄邻域研究")
