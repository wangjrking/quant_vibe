...
import research_active_l4_v260_nonweak_startup_exposure_v272_20260723 as v272
...
OUT = (
    ROOT
    / "quant/data_file/reports/strategy_agent_active_l4_v260_nonweak_startup_exposure_refine_v273_20260723"
)
...
def stable_id(definition: dict) -> str:
    ...
    return "v273_" + hashlib.sha256(raw.encode("utf-8")).hexdigest()[:16]


def main() -> None:
    parser = argparse.ArgumentParser(description="V272 非弱势启动仓位细邻域")
    ...
    definitions = [
        v272.definition_for(protocol, value)
