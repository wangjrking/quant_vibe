...
OUT = ROOT / "quant/data_file/reports/strategy_agent_active_l4_max_hold_daily_review_v226_20260723"


def stable_id(definition: dict) -> str:
    raw = json.dumps(definition, sort_keys=True, separators=(",", ":"))
    return "v226_" + hashlib.sha256(raw.encode("utf-8")).hexdigest()[:16]
