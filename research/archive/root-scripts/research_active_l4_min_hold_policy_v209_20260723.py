...
OUT = ROOT / "quant/data_file/reports/strategy_agent_active_l4_min_hold_policy_v209_20260723"
...
def stable_id(definition: dict) -> str:
    ...
    return "v209_" + hashlib.sha256(raw.encode("utf-8")).hexdigest()[:16]
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Active L4 最短持有期策略研究")
