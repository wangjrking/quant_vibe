...
OUT = ROOT / "quant/data_file/reports/strategy_agent_active_l4_weak_regime_exposure_v141_20260722"
...
def stable_id(definition: dict) -> str:
    ...
    return "v141_" + hashlib.sha256(raw.encode("utf-8")).hexdigest()[:16]


def main() -> None:
    parser = argparse.ArgumentParser(description="正式L4策略弱市暴露研究")
