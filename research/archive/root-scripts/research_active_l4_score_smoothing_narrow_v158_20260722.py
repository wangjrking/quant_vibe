...
OUT = ROOT / "quant/data_file/reports/strategy_agent_active_l4_score_smoothing_narrow_v158_20260722"
...
def stable_id(definition: dict) -> str:
    ...
    return "v158_" + hashlib.sha256(raw.encode("utf-8")).hexdigest()[:16]
...
def main() -> None:
    parser = argparse.ArgumentParser(description="正式L4 10D评分平滑窄邻域研究")
