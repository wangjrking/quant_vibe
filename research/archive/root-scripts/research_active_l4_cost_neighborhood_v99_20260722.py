...
OUT = ROOT / "quant/data_file/reports/strategy_agent_active_l4_cost_neighborhood_v99_20260722"
...
def stable_id(definition: dict) -> str:
    ...
    return "v99_" + hashlib.sha256(raw.encode("utf-8")).hexdigest()[:16]


def main() -> None:
    parser = argparse.ArgumentParser(description="固定0.3%成本的低换手邻域研究")
