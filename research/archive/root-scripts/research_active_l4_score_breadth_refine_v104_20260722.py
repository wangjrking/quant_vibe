...
OUT = ROOT / "quant/data_file/reports/strategy_agent_active_l4_score_breadth_refine_v104_20260722"
...
def stable_id(definition: dict) -> str:
    ...
    return "v104_" + hashlib.sha256(raw.encode("utf-8")).hexdigest()[:16]


def main() -> None:
    parser = argparse.ArgumentParser(description="10D分数广度动态仓位细邻域")
