...
base.REPORT_DIR = (
    ...
    / "reports"
    / "strategy_agent_goal_high_annual_20260623"
    / "current_formal_rank_state_exit"
)
base.FUSION_DB = base.REPORT_DIR / "fusion_rank_state_exit.db"
base.SCORE_DB = base.REPORT_DIR / "scores_rank_state_exit.db"


def _cfg(name: str, rank_rules: dict[int, dict]) -> dict:
    return {
        "name": name,
        "w10": 0.80,
        "w5": 0.20,
        ...
        "env": {
            ...
            "GM_MAX_HOLDING_DAYS": "8",
        },
    }


base.VARIANTS = [
    _cfg("base_equal_state", {}),
    _cfg(
        "top12_longer_34_faster",
        {
            1: {"holding_days": 6, "score_continue_entry_ratio": 0.99, "score_exit_entry_ratio": 0.93},
            2: {"holding_days": 6, "score_continue_entry_ratio": 0.99, "score_exit_entry_ratio": 0.93},
            3: {"holding_days": 4, "score_exit_entry_ratio": 0.95, "min_holding_days_before_score_exit": 1},
            4: {"holding_days": 4, "score_exit_entry_ratio": 0.95, "min_holding_days_before_score_exit": 1},
        },
    ),
    _cfg(
        "top1_long_top4_fast",
        {
            1: {"holding_days": 7, "score_continue_entry_ratio": 0.98, "score_exit_entry_ratio": 0.92},
            2: {"holding_days": 5, "score_exit_entry_ratio": 0.94},
            3: {"holding_days": 4, "score_exit_entry_ratio": 0.95, "min_holding_days_before_score_exit": 1},
            4: {"holding_days": 3, "score_exit_entry_ratio": 0.96, "min_holding_days_before_score_exit": 1},
        },
    ),
    _cfg(
        "all_fast_ranked",
        {
            1: {"holding_days": 5, "score_exit_entry_ratio": 0.93},
            2: {"holding_days": 4, "score_exit_entry_ratio": 0.94, "min_holding_days_before_score_exit": 1},
            3: {"holding_days": 4, "score_exit_entry_ratio": 0.95, "min_holding_days_before_score_exit": 1},
            4: {"holding_days": 3, "score_exit_entry_ratio": 0.96, "min_holding_days_before_score_exit": 1},
        },
    ),
    _cfg(
        "top12_continue_only",
        {
            1: {"holding_days": 5, "score_continue_entry_ratio": 0.98, "score_exit_entry_ratio": 0.94},
            2: {"holding_days": 5, "score_continue_entry_ratio": 0.99, "score_exit_entry_ratio": 0.94},
        },
    ),
    _cfg(
        "top1_long_only",
        {
            1: {"holding_days": 7, "score_continue_entry_ratio": 0.98, "score_exit_entry_ratio": 0.93},
        },
    ),
    _cfg(
        "top34_fast_only",
    ...
    _cfg(
        "top12_long_34_base",
        {
            1: {"holding_days": 6, "score_continue_entry_ratio": 0.99, "score_exit_entry_ratio": 0.94},
            2: {"holding_days": 6, "score_continue_entry_ratio": 0.99, "score_exit_entry_ratio": 0.94},
        },
    ),
]
