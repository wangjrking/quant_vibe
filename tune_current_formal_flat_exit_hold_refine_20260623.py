...
base.REPORT_DIR = (
    ...
    / "reports"
    / "strategy_agent_goal_high_annual_20260623"
    / "current_formal_flat_exit_hold_refine"
)
base.FUSION_DB = base.REPORT_DIR / "fusion_flat_exit_hold_refine.db"
base.SCORE_DB = base.REPORT_DIR / "scores_flat_exit_hold_refine.db"
...
base.VARIANTS = [
    _cfg("flat1322_h5_base", holding_days=5),
    _cfg("flat1322_h4_base", holding_days=4),
    _cfg("flat1322_h6_base", holding_days=6),
    _cfg("flat1322_h7_base", holding_days=7),
    _cfg("flat1322_h5_exit093", holding_days=5, exit_ratio="0.93"),
    _cfg("flat1322_h5_exit095", holding_days=5, exit_ratio="0.95"),
    _cfg("flat1322_h5_norank", holding_days=5, exit_rank=None),
    _cfg("flat1322_h5_rank096", holding_days=5, exit_rank="0.96"),
    _cfg("flat1322_h5_dd995", holding_days=5, day_drop_ratio="0.995"),
    _cfg("flat1322_h5_dd990", holding_days=5, day_drop_ratio="0.990"),
]
