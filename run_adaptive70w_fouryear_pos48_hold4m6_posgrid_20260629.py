...
OUT_DIR = DATA / "reports" / "strategy_agent_adaptive70w_fouryear_pos48_hold4m6_posgrid_20260629"
...
GRID_CASES = [
    {"name": "h4m6_c097_e095_dd96_pos48", "holding_days": 4, "max_holding_days": 6, "target_pct": 0.48, "score_continue_ratio": 0.97, "score_exit_ratio": 0.95, "day_drop_ratio": 0.96},
    {"name": "h4m6_c097_e095_dd96_pos50", "holding_days": 4, "max_holding_days": 6, "target_pct": 0.50, "score_continue_ratio": 0.97, "score_exit_ratio": 0.95, "day_drop_ratio": 0.96},
    {"name": "h4m6_c097_e095_dd96_pos52", "holding_days": 4, "max_holding_days": 6, "target_pct": 0.52, "score_continue_ratio": 0.97, "score_exit_ratio": 0.95, "day_drop_ratio": 0.96},
    {"name": "h4m6_c097_e095_dd96_pos55", "holding_days": 4, "max_holding_days": 6, "target_pct": 0.55, "score_continue_ratio": 0.97, "score_exit_ratio": 0.95, "day_drop_ratio": 0.96},
    {"name": "h4m6_c096_e094_dd96_pos48", "holding_days": 4, "max_holding_days": 6, "target_pct": 0.48, "score_continue_ratio": 0.96, "score_exit_ratio": 0.94, "day_drop_ratio": 0.96},
    {"name": "h4m6_c096_e094_dd96_pos50", "holding_days": 4, "max_holding_days": 6, "target_pct": 0.50, "score_continue_ratio": 0.96, "score_exit_ratio": 0.94, "day_drop_ratio": 0.96},
    {"name": "h4m6_c096_e094_dd96_pos52", "holding_days": 4, "max_holding_days": 6, "target_pct": 0.52, "score_continue_ratio": 0.96, "score_exit_ratio": 0.94, "day_drop_ratio": 0.96},
    {"name": "h4m6_c096_e094_dd96_pos55", "holding_days": 4, "max_holding_days": 6, "target_pct": 0.55, "score_continue_ratio": 0.96, "score_exit_ratio": 0.94, "day_drop_ratio": 0.96},
]
...
def _ensure_case_signal(case: dict[str, Any], base_rows: list[dict[str, Any]]) -> Path:
    ...
    for row in base_rows:
        ...
        item["signal_min_holding_days_before_score_exit"] = "1"
        item["target_pct"] = f"{case['target_pct']:.5f}"
        item["target_position_pct"] = f"{case['target_pct']:.5f}"
        item["dynamic_hold_name"] = case["name"]
        rows.append(item)
...
def main() -> None:
    ...
    for case in GRID_CASES:
        ...
        _write_rows(OUT_DIR / "hold4m6_posgrid_detail.csv", detail)
        _write_rows(OUT_DIR / "hold4m6_posgrid_summary.csv", summary)
