...
REPORT_DIR = DATA_DIR / "reports" / "model_agent_research_10d_gate_refine_fullwindow_20260626"
...
FEATURES = ["top20_overlap", "top10_overlap", "alt_std", "mean_abs_rank_gap", "rank_corr"]
...
def main() -> int:
    ...
    summary = {
        ...
        "scope": "research_only_10d_fullwindow_gate_refine",
