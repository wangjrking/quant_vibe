...
OUT_DIR = DATA / "reports" / "strategy_agent_adaptive70w_fouryear_daydrop95_neighbor_20260629"
...
SIGNAL_DIR = DATA / "reports" / "strategy_agent_adaptive70w_fouryear_momentum_cooldown_focused_20260629" / "signals"
...
CASES = [
    {
        "case_key": "w72_23_05_amt150_mv30__hold3m5_c097_e096_ddtight_pos65__amt150000_mv300000_pc150_pos45_cool2d18",
        "target_pct": 0.45,
    },
    {
    ...
    {
        "case_key": "w72_23_05_amt150_mv30__hold3m5_c097_e096_ddtight_pos65__amt150000_mv300000_pc150_pos55_cool2d18",
        "target_pct": 0.55,
    },
]
...
BASE_ENV = {
    ...
    "GM_SCORE_STOP_LOSS_DAY_DROP_RATIO": "0.95",
...
def _run_case(case: dict[str, Any], tag: str, start: str, end: str) -> dict[str, Any]:
    case_key = case["case_key"]
    signal_file = SIGNAL_DIR / f"{case_key}.csv"
    score_table = f"score_{case_key}"
    log_file = OUT_DIR / "logs" / f"{case_key}__daydrop95__{tag}.log"
...
def main() -> None:
    ...
    for case in CASES:
        ...
        out = {
            "case_key": case["case_key"],
            "target_pct": case["target_pct"],
            "signal_file": rows[0]["signal_file"],
            "signal_rows": rows[0]["signal_rows"],
        }
        ...
        _write_rows(OUT_DIR / "daydrop95_neighbor_detail.csv", detail)
        _write_rows(OUT_DIR / "daydrop95_neighbor_summary.csv", summary)
