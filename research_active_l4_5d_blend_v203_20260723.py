...
OUT = ROOT / "quant/data_file/reports/strategy_agent_active_l4_5d_blend_v203_20260723"
...
def stable_id(definition: dict) -> str:
    ...
    return "v203_" + hashlib.sha256(raw.encode("utf-8")).hexdigest()[:16]


def main() -> None:
    parser = argparse.ArgumentParser(description="Active L4 5D与10D轻量融合研究")
    ...
    for weight_5d in protocol["grid"]["weight_5d"]:
        definition = {**protocol["fixed_definition"], "weight_5d": float(weight_5d)}
