...
SOURCE_DIR = DATA / "reports" / "strategy_agent_adaptive70w_fouryear_pos48_sell_micro_20260629"
OUT_DIR = DATA / "reports" / "strategy_agent_adaptive70w_fouryear_pos48_daydrop97_lowpath_20260629"
...
SIGNAL_FILE = SOURCE_DIR / "signals" / f"{CASE_KEY}__daydrop97.csv"
...
BASE_ENV = {
    ...
    "GM_SCORE_STOP_LOSS_DAY_DROP_RATIO": "0.97",
...
def _run(anchor: str, offset: int, start: str) -> dict[str, Any]:
    ...
    log_file = OUT_DIR / "logs" / f"{CASE_KEY}__daydrop97__{tag}.log"
